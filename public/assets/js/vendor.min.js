...
! function(t, e) {
    ...
    const t = "transitionend",
        ...
        a = t => i(t) ? t.jquery ? t[0] : t : "string" == typeof t && t.length > 0 ? document.querySelector(t) : null,
        o = (t, e, n) => {
            Object.keys(n).forEach(r => {
                const s = n[r],
                    a = e[r],
                    o = a && i(a) ? "element" : null == (l = a) ? "" + l : {}.toString.call(l).match(/\s([a-z]+)/i)[1].toLowerCase();
                var l;
                if (!new RegExp(s).test(o)) throw new TypeError(`${t.toUpperCase()}: Option "${r}" provided type "${o}" but expected type "${s}".`)
            })
        },
        l = t => !(!i(t) || 0 === t.getClientRects().length) && "visible" === getComputedStyle(t).getPropertyValue("visibility"),
        ...
        y = (e, n, r = !0) => {
            ...
            const i = (t => {
                ...
                return r || s ? (e = e.split(",")[0], n = n.split(",")[0], 1e3 * (Number.parseFloat(e) + Number.parseFloat(n))) : 0
            })(n) + 5;
            let a = !1;
            const o = ({
                target: r
            }) => {
                r === n && (a = !0, n.removeEventListener(t, o), v(e))
            };
            n.addEventListener(t, o), setTimeout(() => {
                a || s(n)
            }, i)
        },
        b = (t, e, n, r) => {
            let s = t.indexOf(e);
            if (-1 === s) return t[!n && r ? t.length - 1 : 0];
            const i = t.length;
            return s += n ? 1 : -1, r && (s = (s + i) % i), t[Math.max(0, Math.min(s, i - 1))]
        },
        _ = /[^.]*(?=\..*)\.|.*/,
        w = /\..*/,
        S = /::\d+$/,
    ...
    function M(t, e, n = null) {
        ...
        for (let s = 0, i = r.length; s < i; s++) {
            const i = t[r[s]];
            if (i.originalHandler === e && i.delegationSelector === n) return i
        }
        return null
    }
    ...
    function A(t, e, n) {
        const r = "string" == typeof e,
            s = r ? n : e;
        let i = D(t);
        return T.has(i) || (i = t), [r, s, i]
    }

    function j(t, e, n, r, s) {
        if ("string" != typeof e || !t) return;
        if (n || (n = r, r = null), k.test(e)) {
            const t = t => function(e) {
                if (!e.relatedTarget || e.relatedTarget !== e.delegateTarget && !e.delegateTarget.contains(e.relatedTarget)) return t.call(this, e)
            };
            r ? r = t(r) : n = t(n)
        }
        const [i, a, o] = A(e, n, r), l = O(t), c = l[o] || (l[o] = {}), u = M(c, a, i ? n : null);
        if (u) return void(u.oneOff = u.oneOff && s);
        const p = P(a, e.replace(_, "")),
            d = i ? function(t, e, n) {
                return function r(s) {
                    ...
                    for (let {
                        ...
                        for (let o = i.length; o--;)
                            if (i[o] === a) return s.delegateTarget = a, r.oneOff && L.off(t, s.type, e, n), n.apply(a, [s]);
                    return null
                }
            }(t, n, r) : function(t, e) {
                return function n(r) {
                    return r.delegateTarget = t, n.oneOff && L.off(t, r.type, e), e.apply(t, [r])
                }
            }(t, n);
        d.delegationSelector = i ? n : null, d.originalHandler = a, d.oneOff = s, d.uidEvent = p, c[p] = d, t.addEventListener(o, d, i)
    }
    ...
    const L = {
            ...
            off(t, e, n, r) {
                if ("string" != typeof e || !t) return;
                const [s, i, a] = A(e, n, r), o = a !== e, l = O(t), c = e.startsWith(".");
                if (void 0 !== i) {
                    if (!l || !l[a]) return;
                    return void I(t, l, a, i, s ? n : null)
                }
                c && Object.keys(l).forEach(n => {
                    ! function(t, e, n, r) {
                        ...
                        Object.keys(s).forEach(i => {
                            if (i.includes(r)) {
                                const r = s[i];
                                I(t, e, n, r.originalHandler, r.delegationSelector)
                            }
                        })
                    }(t, l, n, e.slice(1))
                });
                ...
                Object.keys(u).forEach(n => {
                    ...
                    if (!o || e.includes(r)) {
                        const e = u[n];
                        I(t, l, a, e.originalHandler, e.delegationSelector)
                    }
                })
            },
            trigger(t, e, n) {
                ...
                let o, l = !0,
                    ...
                    u = !1,
                    p = null;
                return i && r && (o = r.Event(e, n), r(t).trigger(o), l = !o.isPropagationStopped(), c = !o.isImmediatePropagationStopped(), u = o.isDefaultPrevented()), a ? (p = document.createEvent("HTMLEvents"), p.initEvent(s, l, !0)) : p = new CustomEvent(e, {
                    bubbles: l,
                    cancelable: !0
                ...
                }), u && p.preventDefault(), c && t.dispatchEvent(p), p.defaultPrevented && void 0 !== o && o.preventDefault(), p
            }
        },
        V = new Map,
        $ = {
    ...
    class N {
        constructor(t) {
            (t = a(t)) && (this._element = t, $.set(this._element, this.constructor.DATA_KEY, this))
        }
        dispose() {
            $.remove(this._element, this.constructor.DATA_KEY), L.off(this._element, this.constructor.EVENT_KEY), Object.getOwnPropertyNames(this).forEach(t => {
                this[t] = null
            })
        }
    ...
    const H = (t, e = "hide") => {
        const n = "click.dismiss" + t.EVENT_KEY,
            s = t.NAME;
        L.on(document, n, `[data-bs-dismiss="${s}"]`, (function(n) {
    ...
    L.on(document, "click.bs.button.data-api", z, t => {
        t.preventDefault();
    ...
    const W = {
            ...
            getDataAttributes(t) {
                ...
                return Object.keys(t.dataset).filter(t => t.startsWith("bs")).forEach(n => {
                    let r = n.replace(/^bs/, "");
                    r = r.charAt(0).toLowerCase() + r.slice(1, r.length), e[r] = B(t.dataset[n])
                }), e
            },
    ...
    class st extends N {
        ...
        to(t) {
            this._activeElement = U.findOne(rt, this._element);
            const e = this._getItemIndex(this._activeElement);
            if (t > this._items.length - 1 || t < 0) return;
            if (this._isSliding) return void L.one(this._element, et, () => this.to(t));
        ...
        _addEventListeners() {
            this._config.keyboard && L.on(this._element, "keydown.bs.carousel", t => this._keydown(t)), "hover" === this._config.pause && (L.on(this._element, "mouseenter.bs.carousel", t => this.pause(t)), L.on(this._element, "mouseleave.bs.carousel", t => this.cycle(t))), this._config.touch && this._touchSupported && this._addTouchEventListeners()
        }
        _addTouchEventListeners() {
            ...
            }), this._pointerEvent ? (L.on(this._element, "pointerdown.bs.carousel", t => e(t)), L.on(this._element, "pointerup.bs.carousel", t => r(t)), this._element.classList.add("pointer-event")) : (L.on(this._element, "touchstart.bs.carousel", t => e(t)), L.on(this._element, "touchmove.bs.carousel", t => n(t)), L.on(this._element, "touchend.bs.carousel", t => r(t)))
        }
        _keydown(t) {
        ...
        _triggerSlideEvent(t, e) {
            const n = this._getItemIndex(t),
                r = this._getItemIndex(U.findOne(rt, this._element));
            ...
            if (this._indicatorsElement) {
                ...
                for (let e = 0; e < n.length; e++)
                    if (Number.parseInt(n[e].getAttribute("data-bs-slide-to"), 10) === this._getItemIndex(t)) {
                        n[e].classList.add(nt), n[e].setAttribute("aria-current", "true");
                        break
                    }
            }
        }
        _updateInterval() {
            const t = this._activeElement || U.findOne(rt, this._element);
            if (!t) return;
        ...
        _slide(t, e) {
            ...
            if (i && i.classList.contains(nt)) return void(this._isSliding = !1);
            if (this._isSliding) return;
            if (this._triggerSlideEvent(i, p).defaultPrevented) return;
            if (!r || !i) return;
            this._isSliding = !0, o && this.pause(), this._setActiveIndicatorElement(i), this._activeElement = i;
            const h = () => {
            ...
            if (this._element.classList.contains("slide")) {
                i.classList.add(u), d(i), r.classList.add(c), i.classList.add(c);
                const t = () => {
                    i.classList.remove(c, u), i.classList.add(nt), r.classList.remove(nt, u, c), this._isSliding = !1, setTimeout(h, 0)
                };
                this._queueCallback(t, r, !0)
            } else r.classList.remove(nt), i.classList.add(nt), this._isSliding = !1, h();
            o && this.cycle()
        }
        _directionToOrder(t) {
            return [Z, J].includes(t) ? m() ? t === J ? Q : K : t === J ? K : Q : t
        }
        _orderToDirection(t) {
            return [K, Q].includes(t) ? m() ? t === Q ? J : Z : t === Q ? Z : J : t
        }
        static carouselInterface(t, e) {
            const n = st.getOrCreateInstance(t, e);
            let {
                _config: r
            } = n;
            "object" == typeof e && (r = { ...r,
        ...
        static dataApiClickHandler(t) {
            ...
            const n = { ...W.getDataAttributes(e),
                    ...W.getDataAttributes(this)
                },
                s = this.getAttribute("data-bs-slide-to");
            s && (n.interval = !1), st.carouselInterface(e, n), s && st.getInstance(e).to(s), t.preventDefault()
        }
    }
    L.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", st.dataApiClickHandler), L.on(window, "load.bs.carousel.data-api", () => {
        const t = U.find('[data-bs-ride="carousel"]');
        for (let e = 0, n = t.length; e < n; e++) st.carouselInterface(t[e], st.getInstance(t[e]))
    }), g(st);
    const it = "collapse",
        at = {
            toggle: !0,
    ...
    class ft extends N {
        constructor(t, e) {
            ...
            for (let t = 0, e = r.length; t < e; t++) {
                const e = r[t],
                    s = n(e),
                    i = U.find(s).filter(t => t === this._element);
                null !== s && i.length && (this._selector = s, this._triggerArray.push(e))
            }
        ...
        show() {
            ...
            e.forEach(e => {
                n !== e && ft.getOrCreateInstance(e, {
                    toggle: !1
                }).hide(), t || $.set(e, "bs.collapse", null)
            });
            const r = this._getDimension();
            this._element.classList.remove(ct), this._element.classList.add(ut), this._element.style[r] = 0, this._addAriaAndCollapsedClass(this._triggerArray, !0), this._isTransitioning = !0;
            const s = "scroll" + (r[0].toUpperCase() + r.slice(1));
            this._queueCallback(() => {
                this._isTransitioning = !1, this._element.classList.remove(ut), this._element.classList.add(ct, lt), this._element.style[r] = "", L.trigger(this._element, "shown.bs.collapse")
            }, this._element, !0), this._element.style[r] = this._element[s] + "px"
        }
        hide() {
            if (this._isTransitioning || !this._isShown()) return;
            ...
            this._isTransitioning = !0, this._element.style[t] = "", this._queueCallback(() => {
                this._isTransitioning = !1, this._element.classList.remove(ut), this._element.classList.add(ct), L.trigger(this._element, "hidden.bs.collapse")
            }, this._element, !0)
        }
        ...
        _getConfig(t) {
            return (t = { ...at,
                ...W.getDataAttributes(this._element),
                ...t
            }).toggle = Boolean(t.toggle), t.parent = a(t.parent), o(it, t, ot), t
        }
        _getDimension() {
        ...
        _initializeChildren() {
            ...
            const t = U.find(dt, this._config.parent);
            U.find(ht, this._config.parent).filter(e => !t.includes(e)).forEach(t => {
                const e = r(t);
        ...
        _addAriaAndCollapsedClass(t, e) {
            t.length && t.forEach(t => {
                e ? t.classList.remove(pt) : t.classList.add(pt), t.setAttribute("aria-expanded", e)
            })
        }
        static jQueryInterface(t) {
            return this.each((function() {
    ...
    L.on(document, "click.bs.collapse.data-api", ht, (function(t) {
    ...
    var mt = "top",
        ...
        It = "beforeWrite",
        Dt = "afterWrite",
        Lt = [Ot, "read", Mt, At, "main", jt, It, "write", Dt];
        ...
        fn: function(t) {
            ...
            Object.keys(e.elements).forEach((function(t) {
                var n = e.styles[t] || {},
                    r = e.attributes[t] || {},
                    s = e.elements[t];
                Ht(s) && Vt(s) && (Object.assign(s.style, n), Object.keys(r).forEach((function(t) {
                    var e = r[t];
            ...
            return Object.assign(e.elements.popper.style, n.popper), e.styles = n, e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow),
                function() {
                    Object.keys(e.elements).forEach((function(t) {
                        ...
                        Ht(r) && Vt(r) && (Object.assign(r.style, i), Object.keys(s).forEach((function(t) {
                            r.removeAttribute(t)
                        })))
                    }))
                }
    ...
    function Xt(t) {
        return "html" === Vt(t) ? t : t.assignedSlot || t.parentNode || (Rt(t) ? t.host : null) || Yt(t)
    }

    function Kt(t) {
        return Ht(t) && "fixed" !== Ut(t).position ? t.offsetParent : null
    }

    function Qt(t) {
        for (var e = $t(t), n = Kt(t); n && Gt(n) && "static" === Ut(n).position;) n = Kt(n);
        return n && ("html" === Vt(n) || "body" === Vt(n) && "static" === Ut(n).position) ? e : n || function(t) {
            var e = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
            if (-1 !== navigator.userAgent.indexOf("Trident") && Ht(t) && "fixed" === Ut(t).position) return null;
            for (var n = Xt(t); Ht(n) && ["html", "body"].indexOf(Vt(n)) < 0;) {
                var r = Ut(n);
    ...
    const ie = {
        ...
        effect: function(t) {
            ...
            null != r && ("string" != typeof r || (r = e.elements.popper.querySelector(r))) && Wt(e.elements.popper, r) && (e.elements.arrow = r)
        },
    ...
    function le(t) {
        ...
        if (c) {
            var w = Qt(n),
                S = "clientHeight",
                C = "clientWidth";
            w === $t(n) && "static" !== Ut(w = Yt(n)).position && "absolute" === o && (S = "scrollHeight", C = "scrollWidth"), w = w, s !== mt && (s !== yt && s !== vt || i !== St) || (b = gt, m -= w[S] - r.height, m *= l ? 1 : -1), s !== yt && (s !== mt && s !== gt || i !== St) || (y = vt, h -= w[C] - r.width, h *= l ? 1 : -1)
        }
        var x, E = Object.assign({
            position: o
        }, c && oe);
        return l ? Object.assign({}, E, ((x = {})[b] = v ? "0" : "", x[y] = g ? "0" : "", x.transform = (_.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + m + "px)" : "translate3d(" + h + "px, " + m + "px, 0)", x)) : Object.assign({}, E, ((e = {})[b] = v ? m + "px" : "", e[y] = g ? h + "px" : "", e.transform = "", e))
    }
    const ce = {
        name: "computeStyles",
        enabled: !0,
    ...
    const pe = {
        ...
        effect: function(t) {
            ...
            return i && c.forEach((function(t) {
                ...
                })), o && l.addEventListener("resize", n.update, ue),
                function() {
                    i && c.forEach((function(t) {
                        t.removeEventListener("scroll", n.update, ue)
                    })), o && l.removeEventListener("resize", n.update, ue)
                }
        },
        data: {}
    };
    ...
    function ve(t) {
        return Bt(Yt(t)).left + ge(t).scrollLeft
    }
    ...
    function be(t, e) {
        ...
        void 0 === e && (e = []);
        var r = function t(e) {
                return ["html", "body", "#document"].indexOf(Vt(e)) >= 0 ? e.ownerDocument.body : Ht(e) && ye(e) ? e : t(Xt(e))
            }(t),
            s = r === (null == (n = t.ownerDocument) ? void 0 : n.body),
            i = $t(r),
            a = s ? [i].concat(i.visualViewport || [], ye(r) ? r : []) : r,
            o = e.concat(a);
        return s ? o : o.concat(be(Xt(a)))
    }
    ...
    function we(t, e) {
        return e === xt ? _e(function(t) {
            var e = $t(t),
                ...
                a = 0,
                o = 0;
            return r && (s = r.width, i = r.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (a = r.offsetLeft, o = r.offsetTop)), {
                width: s,
                height: i,
                x: a + ve(t),
                y: o
            ...
            var e, n = Yt(t),
                ...
                i = Zt(n.scrollWidth, n.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0),
                a = Zt(n.scrollHeight, n.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0),
                o = -r.scrollLeft + ve(t),
                l = -r.scrollTop;
            return "rtl" === Ut(s || n).direction && (o += Zt(n.clientWidth, s ? s.clientWidth : 0) - i), {
                width: i,
                height: a,
                x: o,
                y: l
    ...
    function Ce(t, e) {
        ...
        var n = e,
            ...
            h = n.padding,
            f = void 0 === h ? 0 : h,
            m = re("number" != typeof f ? f : se(f, _t)),
            g = u === Et ? kt : Et,
            v = t.rects.popper,
            y = t.elements[d ? g : u],
            b = function(t, e, n) {
                var r = "clippingParents" === e ? function(t) {
                        var e = be(Xt(t)),
                            n = ["absolute", "fixed"].indexOf(Ut(t).position) >= 0 && Ht(t) ? Qt(t) : t;
                        return Nt(n) ? e.filter((function(t) {
                            return Nt(t) && Wt(t, n) && "body" !== Vt(t)
                        })) : []
                    }(t) : [].concat(e),
                    s = [].concat(r, [n]),
                    i = s[0],
                    a = s.reduce((function(e, n) {
                        var r = we(t, n);
                        return e.top = Zt(r.top, e.top), e.right = te(r.right, e.right), e.bottom = te(r.bottom, e.bottom), e.left = Zt(r.left, e.left), e
                    }), we(t, i));
                return a.width = a.right - a.left, a.height = a.bottom - a.top, a.x = a.left, a.y = a.top, a
            }(Nt(y) ? y : y.contextElement || Yt(t.elements.popper), a, l),
            _ = Bt(t.elements.reference),
            w = Se({
                reference: _,
                element: v,
                strategy: "absolute",
    ...
    const xe = {
        ...
        fn: function(t) {
            ...
            if (!e.modifiersData[r]._skip) {
                for (var s = n.mainAxis, i = void 0 === s || s, a = n.altAxis, o = void 0 === a || a, l = n.fallbackPlacements, c = n.padding, u = n.boundary, p = n.rootBoundary, d = n.altBoundary, h = n.flipVariations, f = void 0 === h || h, m = n.allowedAutoPlacements, g = e.options.placement, v = qt(g), y = l || (v !== g && f ? function(t) {
                        if (qt(t) === bt) return [];
                        var e = he(t);
                        return [me(t), e, me(e)]
                    }(g) : [he(g)]), b = [g].concat(y).reduce((function(t, n) {
                        return t.concat(qt(n) === bt ? function(t, e) {
                            void 0 === e && (e = {});
                            var n = e,
                                r = n.placement,
                                s = n.boundary,
                    ...
                    var I = he(j),
                        D = [];
                    if (i && D.push(A[T] <= 0), o && D.push(A[j] <= 0, A[I] <= 0), D.every((function(t) {
                            return t
                        }))) {
                        x = k, C = !1;
                        break
                    ...
                    a = Pt.reduce((function(t, n) {
                        return t[n] = function(t, e, n) {
                            var r = qt(t),
                                ...
                                a = i[0],
                                o = i[1];
                            return a = a || 0, o = (o || 0) * s, [yt, vt].indexOf(r) >= 0 ? {
                                x: o,
                                y: a
                            } : {
                                x: a,
                    ...
                    if (i || o) {
                        ...
                        if (o) {
                            var K = "x" === _ ? mt : yt,
                                ...
                                Z = J + g[K],
                                tt = J - g[Q],
                                et = ne(h ? te(Z, G) : Z, J, h ? Zt(tt, Y) : tt);
                            S[w] = et, k[w] = et - J
                        }
                    }
                    e.modifiersData[r] = k
    ...
    function Ae(t, e, n) {
        ...
        return (r || !r && !n) && (("body" !== Vt(e) || ye(a)) && (l = (s = e) !== $t(s) && Ht(s) ? {
            scrollLeft: (i = s).scrollLeft,
            scrollTop: i.scrollTop
        } : ge(s)), Ht(e) ? ((c = Bt(e)).x += e.clientLeft, c.y += e.clientTop) : a && (c.x = ve(a))), {
            ...
            var s, a, o = {
                ...
                u = {
                    ...
                    setOptions: function(n) {
                        ...
                        p(), o.options = Object.assign({}, i, o.options, s), o.scrollParents = {
                            reference: Nt(t) ? be(t) : t.contextElement ? be(t.contextElement) : [],
                            popper: be(e)
                        };
                        ...
                        }((a = [].concat(r, o.options.modifiers), c = a.reduce((function(t, e) {
                            var n = t[e.name];
                    ...
                    forceUpdate: function() {
                        if (!c) {
                            ...
                            if (De(e, n)) {
                                o.rects = {
                                    reference: Ae(e, Qt(n), "fixed" === o.options.strategy),
                                    popper: Ft(n)
    ...
    var Ve = Le(),
        $e = Le({
            defaultModifiers: [pe, Oe, ce, zt]
        }),
        Ne = Le({
            defaultModifiers: [pe, Oe, ce, zt, Pe, xe, Me, ie, Te]
        });
    const He = Object.freeze({
        ...
        qe = "ArrowUp",
        Be = "ArrowDown",
        Fe = new RegExp("ArrowUp|ArrowDown|Escape"),
        We = "click.bs.dropdown.data-api",
        Ue = "keydown.bs.dropdown.data-api",
        Ge = "show",
        Ye = '[data-bs-toggle="dropdown"]',
        Xe = ".dropdown-menu",
        Ke = m() ? "top-end" : "top-start",
        Qe = m() ? "top-start" : "top-end",
        Je = m() ? "bottom-end" : "bottom-start",
        Ze = m() ? "bottom-start" : "bottom-end",
        tn = m() ? "left-start" : "right-start",
    ...
    class sn extends N {
        ...
        _completeHide(t) {
            L.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented || ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(t => L.off(t, "mouseover", p)), this._popper && this._popper.destroy(), this._menu.classList.remove(Ge), this._element.classList.remove(Ge), this._element.setAttribute("aria-expanded", "false"), W.removeDataAttribute(this._menu, "popper"), L.trigger(this._element, "hidden.bs.dropdown", t))
        }
        _getConfig(t) {
            if (t = { ...this.constructor.Default,
                    ...W.getDataAttributes(this._element),
                    ...t
                }, o(Re, t, this.constructor.DefaultType), "object" == typeof t.reference && !i(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError(Re.toUpperCase() + ': Option "reference" provided type "object" without a required "getBoundingClientRect" method.');
            return t
        }
        _createPopper(t) {
            if (void 0 === He) throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)");
            let e = this._element;
            "parent" === this._config.reference ? e = t : i(this._config.reference) ? e = a(this._config.reference) : "object" == typeof this._config.reference && (e = this._config.reference);
            const n = this._getPopperConfig(),
                r = n.modifiers.find(t => "applyStyles" === t.name && !1 === t.enabled);
            this._popper = Ne(e, this._menu, n), r && W.setDataAttribute(this._menu, "popper", "static")
        }
        _isShown(t = this._element) {
            return t.classList.contains(Ge)
        }
        _getMenuElement() {
            return U.next(this._element, Xe)[0]
        }
        _getPlacement() {
            const t = this._element.parentNode;
            if (t.classList.contains("dropend")) return tn;
            if (t.classList.contains("dropstart")) return en;
            const e = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim();
            return t.classList.contains("dropup") ? e ? Qe : Ke : e ? Ze : Je
        }
        _detectNavbar() {
        ...
        _selectMenuItem({
            ...
            const n = U.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", this._menu).filter(l);
            n.length && b(n, e, t === Be, !n.includes(e)).focus()
        }
        static jQueryInterface(t) {
            return this.each((function() {
        ...
        static dataApiKeydownHandler(t) {
            if (/input|textarea/i.test(t.target.tagName) ? "Space" === t.key || t.key !== ze && (t.key !== Be && t.key !== qe || t.target.closest(Xe)) : !Fe.test(t.key)) return;
            const e = this.classList.contains(Ge);
            if (!e && t.key === ze) return;
            if (t.preventDefault(), t.stopPropagation(), c(this)) return;
            const n = this.matches(Ye) ? this : U.prev(this, Ye)[0],
                r = sn.getOrCreateInstance(n);
            if (t.key !== ze) return t.key === qe || t.key === Be ? (e || r.show(), void r._selectMenuItem(t)) : void(e && "Space" !== t.key || sn.clearMenus());
            r.hide()
        }
    }
    L.on(document, Ue, Ye, sn.dataApiKeydownHandler), L.on(document, Ue, Xe, sn.dataApiKeydownHandler), L.on(document, We, sn.clearMenus), L.on(document, "keyup.bs.dropdown.data-api", sn.clearMenus), L.on(document, We, Ye, (function(t) {
    ...
    class ln {
        ...
        hide() {
            ...
            this._disableOverFlow(), this._setElementAttributes(this._element, "paddingRight", e => e + t), this._setElementAttributes(an, "paddingRight", e => e + t), this._setElementAttributes(on, "marginRight", e => e - t)
        }
        _disableOverFlow() {
        ...
        reset() {
            this._resetElementAttributes(this._element, "overflow"), this._resetElementAttributes(this._element, "paddingRight"), this._resetElementAttributes(an, "paddingRight"), this._resetElementAttributes(on, "marginRight")
        }
        ...
        _resetElementAttributes(t, e) {
            this._applyManipulationCallback(t, t => {
                ...
                void 0 === n ? t.style.removeProperty(e) : (W.removeDataAttribute(t, e), t.style[e] = n)
            })
        }
        _applyManipulationCallback(t, e) {
            i(t) ? e(t) : U.find(t, this._element).forEach(e)
        }
        isOverflowing() {
    ...
    class dn {
        ...
        _getConfig(t) {
            return (t = { ...cn,
                ..."object" == typeof t ? t : {}
            }).rootElement = a(t.rootElement), o("backdrop", t, un), t
        }
        _append() {
            this._isAppended || (this._config.rootElement.append(this._getElement()), L.on(this._getElement(), pn, () => {
                v(this._config.clickCallback)
            }), this._isAppended = !0)
        }
        dispose() {
            this._isAppended && (L.off(this._element, pn), this._element.remove(), this._isAppended = !1)
        }
        _emulateAnimation(t) {
    ...
    class vn {
        ...
        activate() {
            ...
            this._isActive || (e && t.focus(), L.off(document, mn), L.on(document, "focusin.bs.focustrap", t => this._handleFocusin(t)), L.on(document, "keydown.tab.bs.focustrap", t => this._handleKeydown(t)), this._isActive = !0)
        }
        deactivate() {
            this._isActive && (this._isActive = !1, L.off(document, mn))
        }
        _handleFocusin(t) {
            const {
                target: e
            ...
            0 === r.length ? n.focus() : this._lastTabNavDirection === gn ? r[r.length - 1].focus() : r[0].focus()
        }
        _handleKeydown(t) {
            "Tab" === t.key && (this._lastTabNavDirection = t.shiftKey ? gn : "forward")
        }
        _getConfig(t) {
            return t = { ...hn,
                ..."object" == typeof t ? t : {}
    ...
    const yn = {
        ...
        wn = "show.bs.modal",
        Sn = "resize.bs.modal",
        Cn = "click.dismiss.bs.modal",
        xn = "keydown.dismiss.bs.modal",
        En = "mousedown.dismiss.bs.modal",
        kn = "modal-open",
        Tn = "modal-static";
    class Pn extends N {
        constructor(t, e) {
            super(t), this._config = this._getConfig(e), this._dialog = U.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollBar = new ln
        }
        static get Default() {
            return yn
        }
        ...
        show(t) {
            this._isShown || this._isTransitioning || L.trigger(this._element, wn, {
                relatedTarget: t
            }).defaultPrevented || (this._isShown = !0, this._isAnimated() && (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(kn), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), L.on(this._dialog, En, () => {
        ...
        hide() {
            ...
            t && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), this._focustrap.deactivate(), this._element.classList.remove("show"), L.off(this._element, Cn), L.off(this._dialog, En), this._queueCallback(() => this._hideModal(), this._element, t)
        }
        dispose() {
            [window, this._dialog].forEach(t => L.off(t, ".bs.modal")), this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose()
        }
        handleUpdate() {
            this._adjustDialog()
        }
        ...
        _setEscapeEvent() {
            this._isShown ? L.on(this._element, xn, t => {
                this._config.keyboard && "Escape" === t.key ? (t.preventDefault(), this.hide()) : this._config.keyboard || "Escape" !== t.key || this._triggerBackdropTransition()
            }) : L.off(this._element, xn)
        }
        _setResizeEvent() {
            this._isShown ? L.on(window, Sn, () => this._adjustDialog()) : L.off(window, Sn)
        }
        _hideModal() {
            this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._backdrop.hide(() => {
                document.body.classList.remove(kn), this._resetAdjustments(), this._scrollBar.reset(), L.trigger(this._element, _n)
            })
        }
        _showBackdrop(t) {
            L.on(this._element, Cn, t => {
        ...
        _triggerBackdropTransition() {
            ...
            const {
                ...
                scrollHeight: e,
                style: n
            } = this._element, r = e > document.documentElement.clientHeight;
            !r && "hidden" === n.overflowY || t.contains(Tn) || (r || (n.overflowY = "hidden"), t.add(Tn), this._queueCallback(() => {
                t.remove(Tn), r || this._queueCallback(() => {
                    n.overflowY = ""
                }, this._dialog)
    ...
    L.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', (function(t) {
        const e = r(this);
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(), L.one(e, wn, t => {
            t.defaultPrevented || L.one(e, _n, () => {
                l(this) && this.focus()
            })
        });
    ...
    class Dn extends N {
        ...
        show(t) {
            this._isShown || L.trigger(this._element, "show.bs.offcanvas", {
                relatedTarget: t
            }).defaultPrevented || (this._isShown = !0, this._element.style.visibility = "visible", this._backdrop.show(), this._config.scroll || (new ln).hide(), this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add("show"), this._queueCallback(() => {
                this._config.scroll || this._focustrap.activate(), L.trigger(this._element, "shown.bs.offcanvas", {
                    relatedTarget: t
                })
            }, this._element, !0))
        }
        hide() {
            this._isShown && (L.trigger(this._element, "hide.bs.offcanvas").defaultPrevented || (this._focustrap.deactivate(), this._element.blur(), this._isShown = !1, this._element.classList.remove("show"), this._backdrop.hide(), this._queueCallback(() => {
                this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._element.style.visibility = "hidden", this._config.scroll || (new ln).reset(), L.trigger(this._element, In)
            }, this._element, !0)))
        }
        dispose() {
    ...
    L.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', (function(t) {
        ...
        const n = U.findOne(jn);
        n && n !== e && Dn.getInstance(n).hide(), Dn.getOrCreateInstance(e).toggle(this)
    })), L.on(window, "load.bs.offcanvas.data-api", () => U.find(jn).forEach(t => Dn.getOrCreateInstance(t).show())), H(Dn), g(Dn);
    const Ln = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
        ...
        Nn = (t, e) => {
            ...
            if (e.includes(n)) return !Ln.has(n) || Boolean(Vn.test(t.nodeValue) || $n.test(t.nodeValue));
    ...
    function Hn(t, e, n) {
        ...
        for (let t = 0, n = s.length; t < n; t++) {
            ...
            const i = [].concat(...n.attributes),
                a = [].concat(e["*"] || [], e[r] || []);
            i.forEach(t => {
                Nn(t, a) || n.removeAttribute(t.nodeName)
            })
        }
    ...
    class Jn extends N {
        ...
        toggle(t) {
            if (this._isEnabled)
                if (t) {
                    ...
                    if (this.getTipElement().classList.contains(Gn)) return void this._leave(null, this);
                    this._enter(null, this)
                }
        }
        dispose() {
            clearTimeout(this._timeout), L.off(this._element.closest(".modal"), Kn, this._hideModalHandler), this.tip && this.tip.remove(), this._disposePopper(), super.dispose()
        }
        show() {
            ...
            "tooltip" === this.constructor.NAME && this.tip && this.getTitle() !== this.tip.querySelector(Xn).innerHTML && (this._disposePopper(), this.tip.remove(), this.tip = null);
            ...
            r.setAttribute("id", s), this._element.setAttribute("aria-describedby", s), this._config.animation && r.classList.add(Un);
            ...
            $.set(r, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || (o.append(r), L.trigger(this._element, this.constructor.Event.INSERTED)), this._popper ? this._popper.update() : this._popper = Ne(this._element, r, this._getPopperConfig(a)), r.classList.add(Gn);
            const l = this._resolvePossibleFunction(this._config.customClass);
            l && r.classList.add(...l.split(" ")), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(t => {
                L.on(t, "mouseover", p)
            });
            const c = this.tip.classList.contains(Un);
            this._queueCallback(() => {
                const t = this._hoverState;
                this._hoverState = null, L.trigger(this._element, this.constructor.Event.SHOWN), "out" === t && this._leave(null, this)
            }, this.tip, c)
        }
        hide() {
            ...
            t.classList.remove(Gn), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(t => L.off(t, "mouseover", p)), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1;
            const e = this.tip.classList.contains(Un);
            this._queueCallback(() => {
                this._isWithActiveTrigger() || (this._hoverState !== Yn && t.remove(), this._cleanTipClass(), this._element.removeAttribute("aria-describedby"), L.trigger(this._element, this.constructor.Event.HIDDEN), this._disposePopper())
        ...
        getTipElement() {
            ...
            return this.setContent(e), e.classList.remove(Un, Gn), this.tip = e, this.tip
        }
        setContent(t) {
            this._sanitizeAndSetContent(t, this.getTitle(), Xn)
        }
        ...
        setElementContent(t, e) {
            if (null !== t) return i(e) ? (e = a(e), void(this._config.html ? e.parentNode !== t && (t.innerHTML = "", t.append(e)) : t.textContent = e.textContent)) : void(this._config.html ? (this._config.sanitize && (e = Hn(e, this._config.allowList, this._config.sanitizeFn)), t.innerHTML = e) : t.textContent = e)
        }
        getTitle() {
        ...
        _setListeners() {
            this._config.trigger.split(" ").forEach(t => {
                if ("click" === t) L.on(this._element, this.constructor.Event.CLICK, this._config.selector, t => this.toggle(t));
                    ...
                    const e = t === Qn ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN,
                        n = t === Qn ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT;
                    L.on(this._element, e, this._config.selector, t => this._enter(t)), L.on(this._element, n, this._config.selector, t => this._leave(t))
                }
            }), this._hideModalHandler = () => {
                this._element && this.hide()
            }, L.on(this._element.closest(".modal"), Kn, this._hideModalHandler), this._config.selector ? this._config = { ...this._config,
                trigger: "manual",
                selector: ""
            } : this._fixTitle()
        }
        ...
        _enter(t, e) {
            e = this._initializeOnDelegatedTarget(t, e), t && (e._activeTrigger["focusin" === t.type ? "focus" : Qn] = !0), e.getTipElement().classList.contains(Gn) || e._hoverState === Yn ? e._hoverState = Yn : (clearTimeout(e._timeout), e._hoverState = Yn, e._config.delay && e._config.delay.show ? e._timeout = setTimeout(() => {
                e._hoverState === Yn && e.show()
            }, e._config.delay.show) : e.show())
        }
        _leave(t, e) {
            e = this._initializeOnDelegatedTarget(t, e), t && (e._activeTrigger["focusout" === t.type ? "focus" : Qn] = e._element.contains(t.relatedTarget)), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = "out", e._config.delay && e._config.delay.hide ? e._timeout = setTimeout(() => {
        ...
        _getConfig(t) {
            ...
            return Object.keys(e).forEach(t => {
                ...
                show: t.delay,
                hide: t.delay
            }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), o(Rn, t, this.constructor.DefaultType), t.sanitize && (t.template = Hn(t.template, t.allowList, t.sanitizeFn)), t
        }
        _getDelegateConfig() {
            const t = {};
    ...
    class cr extends N {
        constructor(t, e) {
            super(t), this._scrollElement = "BODY" === this._element.tagName ? window : this._element, this._config = this._getConfig(e), this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, L.on(this._scrollElement, "scroll.bs.scrollspy", () => this._process()), this.refresh(), this._process()
        }
        static get Default() {
            return sr
        }
        ...
        refresh() {
            const t = this._scrollElement === this._scrollElement.window ? "offset" : lr,
                ...
                r = e === lr ? this._getScrollTop() : 0;
            this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), U.find(or, this._config.target).map(t => {
                const s = n(t),
                    i = s ? U.findOne(s) : null;
                if (i) {
                    const t = i.getBoundingClientRect();
                    if (t.width || t.height) return [W[e](i).top + r, s]
                }
                return null
        ...
        _getConfig(t) {
            return (t = { ...sr,
                ...W.getDataAttributes(this._element),
                ..."object" == typeof t && t ? t : {}
            }).target = a(t.target) || document.documentElement, o(rr, t, ir), t
        }
        _getScrollTop() {
        ...
        _activate(t) {
            ...
            const e = or.split(",").map(e => `${e}[data-bs-target="${t}"],${e}[href="${t}"]`),
                n = U.findOne(e.join(","), this._config.target);
            n.classList.add(ar), n.classList.contains("dropdown-item") ? U.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add(ar) : U.parents(n, ".nav, .list-group").forEach(t => {
                U.prev(t, ".nav-link, .list-group-item").forEach(t => t.classList.add(ar)), U.prev(t, ".nav-item").forEach(t => {
                    U.children(t, ".nav-link").forEach(t => t.classList.add(ar))
                })
        ...
        _clear() {
            U.find(or, this._config.target).filter(t => t.classList.contains(ar)).forEach(t => t.classList.remove(ar))
        }
        static jQueryInterface(t) {
            return this.each((function() {
    ...
    L.on(window, "load.bs.scrollspy.data-api", () => {
        U.find('[data-bs-spy="scroll"]').forEach(t => new cr(t))
    }), g(cr);
    const ur = "active",
        pr = ".active",
        dr = ":scope > li > .active";
    class hr extends N {
        ...
        show() {
            if (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains(ur)) return;
            let t;
            const e = r(this._element),
                n = this._element.closest(".nav, .list-group");
            if (n) {
                const e = "UL" === n.nodeName || "OL" === n.nodeName ? dr : pr;
                t = U.find(e, n), t = t[t.length - 1]
            }
            const s = t ? L.trigger(t, "hide.bs.tab", {
                relatedTarget: this._element
            }) : null;
        ...
        _activate(t, e, n) {
            const r = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? U.children(e, pr) : U.find(dr, e))[0],
                s = n && r && r.classList.contains("fade"),
                i = () => this._transitionComplete(t, r, n);
            r && s ? (r.classList.remove("show"), this._queueCallback(i, t, !0)) : i()
        }
        _transitionComplete(t, e, n) {
            if (e) {
                e.classList.remove(ur);
                const t = U.findOne(":scope > .dropdown-menu .active", e.parentNode);
                t && t.classList.remove(ur), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
            }
            t.classList.add(ur), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), d(t), t.classList.contains("fade") && t.classList.add("show");
            let r = t.parentNode;
            if (r && "LI" === r.nodeName && (r = r.parentNode), r && r.classList.contains("dropdown-menu")) {
                const e = t.closest(".dropdown");
                e && U.find(".dropdown-toggle", e).forEach(t => t.classList.add(ur)), t.setAttribute("aria-expanded", !0)
            }
            n && n()
        }
        static jQueryInterface(t) {
    ...
    L.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', (function(t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(), c(this) || hr.getOrCreateInstance(this).show()
    })), g(hr);
    const fr = "show",
        mr = "showing",
        gr = {
    ...
    class yr extends N {
        ...
        show() {
            L.trigger(this._element, "show.bs.toast").defaultPrevented || (this._clearTimeout(), this._config.animation && this._element.classList.add("fade"), this._element.classList.remove("hide"), d(this._element), this._element.classList.add(fr), this._element.classList.add(mr), this._queueCallback(() => {
                this._element.classList.remove(mr), L.trigger(this._element, "shown.bs.toast"), this._maybeScheduleHide()
            }, this._element, this._config.animation))
        }
        hide() {
            this._element.classList.contains(fr) && (L.trigger(this._element, "hide.bs.toast").defaultPrevented || (this._element.classList.add(mr), this._queueCallback(() => {
                this._element.classList.add("hide"), this._element.classList.remove(mr), this._element.classList.remove(fr), L.trigger(this._element, "hidden.bs.toast")
            }, this._element, this._config.animation)))
        }
        dispose() {
            this._clearTimeout(), this._element.classList.contains(fr) && this._element.classList.remove(fr), super.dispose()
        }
        _getConfig(t) {
            return t = { ...vr,
                ...W.getDataAttributes(this._element),
                ..."object" == typeof t && t ? t : {}
            }, o("toast", t, this.constructor.DefaultType), t
        }
        _maybeScheduleHide() {
...
function(t, e) {
    ...
    return d = {
        ...
        return Object.prototype.hasOwnProperty.call(t, e)
    }, f.p = "", f(f.s = "./src/js/hs-nav-scroller.js").default;
        ...
        var r = function() {
            ...
            a = function() {
                function t(e, n) {
                    ...
                    })(this, t), s.initializer.load(this, n, e), this.begin()
                }
                return r(t, [{
                    key: "toggle",
                    value: function() {
                    ...
                    value: function(t, e) {
                        ...
                        return !0 === this.pause.status ? void this.setPauseStatus(t, e, !0) : void(this.timeout = setTimeout((function() {
                            ...
                            if ("^" === a.charAt(0) && /^\^\d+/.test(a)) {
                                var o = 1;
                                o += (a = /\d+/.exec(a)[0]).length, r = parseInt(a), n.temporaryPause = !0, n.options.onTypingPaused(n.arrayPos, n), t = t.substring(0, e) + t.substring(e + o), n.toggleBlinking(!0)
                            }
                            if ("`" === a.charAt(0)) {
                                for (;
                            ...
                            n.timeout = setTimeout((function() {
                                n.toggleBlinking(!1), e >= t.length ? n.doneTyping(t, e) : n.keepTyping(t, e, s), n.temporaryPause && (n.temporaryPause = !1, n.options.onTypingResumed(n.arrayPos, n))
                            }), r)
                        }), r))
                    }
                }, {
...
function(t, e) {
    ...
    const u = {
        ...
        on: function(...t) {
            ...
            function i(t) {
                ...
                if (s.indexOf(t) < 0 && s.unshift(t), c(e).is(n)) r.apply(e, s);
                else {
                    const t = c(e).parents();
                    for (let e = 0; e < t.length; e += 1) c(t[e]).is(n) && r.apply(t[e], s)
                }
            }
            ...
            "function" == typeof t[1] && ([e, r, s] = t, n = void 0), s || (s = !1);
            const o = e.split(" ");
            let l;
                ...
                for (let t = 0; t < this.length; t += 1) {
                    ...
                    if (!n && i.dom7Listeners ? a = i.dom7Listeners[e] : n && i.dom7LiveListeners && (a = i.dom7LiveListeners[e]), a && a.length)
                        for (let t = a.length - 1; t >= 0; t -= 1) {
                            const n = a[t];
                            r && n.listener === r || r && n.listener && n.listener.dom7proxy && n.listener.dom7proxy === r ? (i.removeEventListener(e, n.proxyListener, s), a.splice(t, 1)) : r || (i.removeEventListener(e, n.proxyListener, s), a.splice(t, 1))
                        }
                }
            }
            return this
        ...
        parents: function(t) {
            ...
            for (let n = 0; n < this.length; n += 1) {
                ...
                for (; r;) t ? c(r).is(t) && e.push(r) : e.push(r), r = r.parentNode
            }
            return c(e)
        },
        closest: function(t) {
        ...
        children: function(t) {
            ...
            for (let n = 0; n < this.length; n += 1) {
                ...
                for (let n = 0; n < r.length; n += 1) t && !c(r[n]).is(t) || e.push(r[n])
            }
            return c(e)
        },
        filter: function(t) {
        ...
        for (let s = 1; s < t.length; s += 1) {
            ...
            if (null != i && (r = i, !("undefined" != typeof window && void 0 !== window.HTMLElement ? r instanceof HTMLElement : r && (1 === r.nodeType || 11 === r.nodeType)))) {
                ...
                for (let n = 0, r = t.length; n < r; n += 1) {
                    ...
                    void 0 !== s && s.enumerable && (f(e[r]) && f(i[r]) ? i[r].__swiper__ ? e[r] = i[r] : m(e[r], i[r]) : !f(e[r]) && f(i[r]) ? (e[r] = {}, i[r].__swiper__ ? e[r] = i[r] : m(e[r], i[r])) : e[r] = i[r])
                }
            }
        }
        var r;
        ...
        const c = e > s ? "next" : "prev",
            ...
            p = () => {
                ...
                if (u(d, e) && (d = e), t.wrapperEl.scrollTo({
                        [n]: d
                    }), u(d, e)) return t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.scrollSnapType = "", setTimeout(() => {
    ...
    function S(t = {}) {
        return b || (b = function({
            ...
            const p = s.match(/(iPod)(.*OS\s([\d_]+))?/),
                ...
                h = "Win32" === r;
            let f = "MacIntel" === r;
            return !u && f && e.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${o}x${l}`) >= 0 && (u = s.match(/(Version)\/([\d.]+)/), u || (u = [0, 1, "13_0_0"]), f = !1), c && !h && (a.os = "android", a.android = !0), (u || d || p) && (a.os = "ios", a.ios = !0), a
        }(t)), b
    }
    ...
    function x({
        ...
        let a = n;
        if (a || (a = s > i ? "next" : s < i ? "prev" : "reset"), t.emit("transition" + r), e && s !== i) {
    ...
    function E(t) {
        ...
        let h = c(p.target);
        if ("wrapper" === o.touchEventsTarget && !h.closest(e.wrapperEl).length) return;
        ...
        if (o.noSwiping && (m ? function(t, e = this) {
                return function e(n) {
                    return n && n !== r() && n !== i() ? (n.assignedSlot && (n = n.assignedSlot), n.closest(t) || e(n.getRootNode().host)) : null
                }(e)
            }(f, p.target) : h.closest(f)[0])) return void(e.allowClick = !0);
        ...
        if (Object.assign(a, {
                ...
                isScrolling: void 0,
                startMoving: void 0
            }), l.startX = g, l.startY = v, a.touchStartTime = d(), e.allowClick = !0, e.updateSize(), e.swipeDirection = void 0, o.threshold > 0 && (a.allowThresholdMove = !1), "touchstart" !== p.type) {
            let t = !0;
            h.is(a.focusableElements) && (t = !1), n.activeElement && c(n.activeElement).is(a.focusableElements) && n.activeElement !== h[0] && n.activeElement.blur();
    ...
    function k(t) {
        ...
        if (u.preventedByNestedSwiper) return a.startX = h, void(a.startY = f);
        if (!n.allowTouchMove) return n.allowClick = !1, void(s.isTouched && (Object.assign(a, {
            startX: h,
            startY: f,
            currentX: h,
            currentY: f
        ...
        if (s.isTouchEvent && i.touchReleaseOnEdges && !i.loop)
            if (n.isVertical()) {
                if (f < a.startY && n.translate <= n.maxTranslate() || f > a.startY && n.translate >= n.minTranslate()) return s.isTouched = !1, void(s.isMoved = !1)
            } else if (h < a.startX && n.translate <= n.maxTranslate() || h > a.startX && n.translate >= n.minTranslate()) return;
        if (s.isTouchEvent && e.activeElement && u.target === e.activeElement && c(u.target).is(s.focusableElements)) return s.isMoved = !0, void(n.allowClick = !1);
        ...
        if (void 0 === s.isScrolling) {
            let t;
            n.isHorizontal() && a.currentY === a.startY || n.isVertical() && a.currentX === a.startX ? s.isScrolling = !1 : m * m + g * g >= 25 && (t = 180 * Math.atan2(Math.abs(g), Math.abs(m)) / Math.PI, s.isScrolling = n.isHorizontal() ? t > i.touchAngle : 90 - t > i.touchAngle)
        }
        if (s.isScrolling && n.emit("touchMoveOpposite", u), void 0 === s.startMoving && (a.currentX === a.startX && a.currentY === a.startY || (s.startMoving = !0)), s.isScrolling) return void(s.isTouched = !1);
        if (!s.startMoving) return;
        n.allowClick = !1, !i.cssMode && u.cancelable && u.preventDefault(), i.touchMoveStopPropagation && !i.nested && u.stopPropagation(), s.isMoved || (i.loop && !i.cssMode && n.loopFix(), s.startTranslate = n.getTranslate(), n.setTransition(0), n.animating && n.$wrapperEl.trigger("webkitTransitionEnd transitionend"), s.allowMomentumBounce = !1, !i.grabCursor || !0 !== n.allowSlideNext && !0 !== n.allowSlidePrev || n.setGrabCursor(!0), n.emit("sliderFirstMove", u)), n.emit("sliderMove", u), s.isMoved = !0;
        let v = n.isHorizontal() ? m : g;
        a.diff = v, v *= i.touchRatio, o && (v = -v), n.swipeDirection = v > 0 ? "prev" : "next", s.currentTranslate = v + s.startTranslate;
        let y = !0,
            b = i.resistanceRatio;
        if (i.touchReleaseOnEdges && (b = 0), v > 0 && s.currentTranslate > n.minTranslate() ? (y = !1, i.resistance && (s.currentTranslate = n.minTranslate() - 1 + (-n.minTranslate() + s.startTranslate + v) ** b)) : v < 0 && s.currentTranslate < n.maxTranslate() && (y = !1, i.resistance && (s.currentTranslate = n.maxTranslate() + 1 - (n.maxTranslate() - s.startTranslate - v) ** b)), y && (u.preventedByNestedSwiper = !0), !n.allowSlideNext && "next" === n.swipeDirection && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !n.allowSlidePrev && "prev" === n.swipeDirection && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), n.allowSlidePrev || n.allowSlideNext || (s.currentTranslate = s.startTranslate), i.threshold > 0) {
            if (!(Math.abs(v) > i.threshold || s.allowThresholdMove)) return void(s.currentTranslate = s.startTranslate);
            if (!s.allowThresholdMove) return s.allowThresholdMove = !0, a.startX = a.currentX, a.startY = a.currentY, s.currentTranslate = s.startTranslate, void(a.diff = n.isHorizontal() ? a.currentX - a.startX : a.currentY - a.startY)
        }
    ...
    function T(t) {
        ...
        let h;
        if (n.isTouched = !1, n.isMoved = !1, n.startMoving = !1, h = r.followFinger ? i ? e.translate : -e.translate : -n.currentTranslate, r.cssMode) return;
        ...
        for (let t = 0; t < a.length; t += t < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
            ...
            void 0 !== a[t + e] ? h >= a[t] && h < a[t + e] && (f = t, m = a[t + e] - a[t]) : h >= a[t] && (f = t, m = a[a.length - 1] - a[a.length - 2])
        }
        const g = (h - a[f]) / m,
            v = f < r.slidesPerGroupSkip - 1 ? 1 : r.slidesPerGroup;
        if (u > r.longSwipesMs) {
            if (!r.longSwipes) return void e.slideTo(e.activeIndex);
            "next" === e.swipeDirection && (g >= r.longSwipesRatio ? e.slideTo(f + v) : e.slideTo(f)), "prev" === e.swipeDirection && (g > 1 - r.longSwipesRatio ? e.slideTo(f + v) : e.slideTo(f))
        } else {
            if (!r.shortSwipes) return void e.slideTo(e.activeIndex);
            !e.navigation || l.target !== e.navigation.nextEl && l.target !== e.navigation.prevEl ? ("next" === e.swipeDirection && e.slideTo(f + v), "prev" === e.swipeDirection && e.slideTo(f)) : l.target === e.navigation.nextEl ? e.slideTo(f + v) : e.slideTo(f)
        }
    }
    ...
    function P() {
        ...
        t.allowSlideNext = !0, t.allowSlidePrev = !0, t.updateSize(), t.updateSlides(), t.updateSlidesClasses(), ("auto" === e.slidesPerView || e.slidesPerView > 1) && t.isEnd && !t.isBeginning && !t.params.centeredSlides ? t.slideTo(t.slides.length - 1, 0, !1, !0) : t.slideTo(t.activeIndex, 0, !1, !0), t.autoplay && t.autoplay.running && t.autoplay.paused && t.autoplay.run(), t.allowSlidePrev = s, t.allowSlideNext = r, t.params.watchOverflow && i !== t.snapGrid && t.checkOverflow()
    }
    ...
    function M() {
        ...
        s = 0 === i ? 0 : (t.translate - t.minTranslate()) / i, s !== t.progress && t.updateProgress(n ? -t.translate : t.translate), t.emit("setTranslate", t.translate, !1)
    }
    ...
    const I = (t, e) => {
            ...
            if (c.touch) {
                ...
                a[p](i.start, t.onTouchStart, e), a[p](i.move, t.onTouchMove, c.passiveListener ? {
                    passive: !1,
                    capture: u
                } : u), a[p](i.end, t.onTouchEnd, e), i.cancel && a[p](i.cancel, t.onTouchEnd, e)
            } else a[p](i.start, t.onTouchStart, !1), n[p](i.move, t.onTouchMove, u), n[p](i.end, t.onTouchEnd, !1);
            (s.preventClicks || s.preventClicksPropagation) && a[p]("click", t.onClick, !0), s.cssMode && o[p]("scroll", t.onScroll), s.updateOnWindowResize ? t[d](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", P, !0) : t[d]("observerUpdate", P, !0)
        },
    ...
    const $ = {
            eventsEmitter: {
                ...
                emit(...t) {
                    ...
                    let n, r, s;
                    return "string" == typeof t[0] || Array.isArray(t[0]) ? (n = t[0], r = t.slice(1, t.length), s = e) : (n = t[0].events, r = t[0].data, s = t[0].context || e), r.unshift(s), (Array.isArray(n) ? n : n.split(" ")).forEach(t => {
            ...
            update: {
                ...
                updateSlides: function() {
                    ...
                    let _ = r.spaceBetween,
                        ...
                        C = 0;
                    if (void 0 === i) return;
                    "string" == typeof _ && _.indexOf("%") >= 0 && (_ = parseFloat(_.replace("%", "")) / 100 * i), t.virtualSize = -_, a ? u.css({
                        marginLeft: "",
                        marginBottom: "",
                        marginTop: ""
                    }) : u.css({
                        ...
                        marginBottom: "",
                        marginTop: ""
                    }), r.centeredSlides && r.cssMode && (g(t.wrapperEl, "--swiper-centered-offset-before", ""), g(t.wrapperEl, "--swiper-centered-offset-after", ""));
                    ...
                    for (let s = 0; s < p; s += 1) {
                        E = 0;
                        const a = u.eq(s);
                        if (x && t.grid.updateSlide(s, a, p, e), "none" !== a.css("display")) {
                            if ("auto" === r.slidesPerView) {
                                k && (u[s].style[e("width")] = "");
                                const i = getComputedStyle(a[0]),
                                    o = a[0].style.transform,
                                    l = a[0].style.webkitTransform;
                                if (o && (a[0].style.transform = "none"), l && (a[0].style.webkitTransform = "none"), r.roundLengths) E = t.isHorizontal() ? a.outerWidth(!0) : a.outerHeight(!0);
                                else {
                                    const t = n(i, "width"),
                                        e = n(i, "padding-left"),
                                        r = n(i, "padding-right"),
                                ...
                                o && (a[0].style.transform = o), l && (a[0].style.webkitTransform = l), r.roundLengths && (E = Math.floor(E))
                            } else E = (i - (r.slidesPerView - 1) * _) / r.slidesPerView, r.roundLengths && (E = Math.floor(E)), u[s] && (u[s].style[e("width")] = E + "px");
                            u[s] && (u[s].swiperSlideSize = E), f.push(E), r.centeredSlides ? (w = w + E / 2 + S / 2 + _, 0 === S && 0 !== s && (w = w - i / 2 - _), 0 === s && (w = w - i / 2 - _), Math.abs(w) < .001 && (w = 0), r.roundLengths && (w = Math.floor(w)), C % r.slidesPerGroup == 0 && d.push(w), h.push(w)) : (r.roundLengths && (w = Math.floor(w)), (C - Math.min(t.params.slidesPerGroupSkip, C)) % t.params.slidesPerGroup == 0 && d.push(w), h.push(w), w = w + E + _), t.virtualSize += E + _, S = E, C += 1
                        }
                    }
                    if (t.virtualSize = Math.max(t.virtualSize, i) + v, a && o && ("slide" === r.effect || "coverflow" === r.effect) && s.css({
                            width: t.virtualSize + r.spaceBetween + "px"
                        }), r.setWrapperSize && s.css({
                            [e("width")]: t.virtualSize + r.spaceBetween + "px"
                        }), x && t.grid.updateWrapperSize(E, d, e), !r.centeredSlides) {
                        const e = [];
                        for (let n = 0; n < d.length; n += 1) {
                            let s = d[n];
                            r.roundLengths && (s = Math.floor(s)), d[n] <= t.virtualSize - i && e.push(s)
                        }
                        d = e, Math.floor(t.virtualSize - i) - Math.floor(d[d.length - 1]) > 1 && d.push(t.virtualSize - i)
                    }
                    ...
                    if (Object.assign(t, {
                        ...
                        g(t.wrapperEl, "--swiper-centered-offset-before", -d[0] + "px"), g(t.wrapperEl, "--swiper-centered-offset-after", t.size / 2 - f[f.length - 1] / 2 + "px");
                        const e = -t.snapGrid[0],
                            n = -t.slidesGrid[0];
                        t.snapGrid = t.snapGrid.map(t => t + e), t.slidesGrid = t.slidesGrid.map(t => t + n)
                    }
                    p !== c && t.emit("slidesLengthChange"), d.length !== y && (t.params.watchOverflow && t.checkOverflow(), t.emit("snapGridLengthChange")), h.length !== b && t.emit("slidesGridLengthChange"), r.watchSlidesProgress && t.updateSlidesOffset()
                },
                ...
                updateSlidesProgress: function(t = this && this.translate || 0) {
                    ...
                    let a = -t;
                    s && (a = t), r.removeClass(n.slideVisibleClass), e.visibleSlidesIndexes = [], e.visibleSlides = [];
                    for (let t = 0; t < r.length; t += 1) {
                        const o = r[t];
                        let l = o.swiperSlideOffset;
                        n.cssMode && n.centeredSlides && (l -= r[0].swiperSlideOffset);
                        const c = (a + (n.centeredSlides ? e.minTranslate() : 0) - l) / (o.swiperSlideSize + n.spaceBetween),
                            u = (a - i[0] + (n.centeredSlides ? e.minTranslate() : 0) - l) / (o.swiperSlideSize + n.spaceBetween),
                            p = -(a - l),
                            d = p + e.slidesSizesGrid[t];
                        (p >= 0 && p < e.size - 1 || d > 1 && d <= e.size || p <= 0 && d >= e.size) && (e.visibleSlides.push(o), e.visibleSlidesIndexes.push(t), r.eq(t).addClass(n.slideVisibleClass)), o.progress = s ? -c : c, o.originalProgress = s ? -u : u
                    }
                ...
                updateProgress: function(t) {
                    ...
                    const o = i,
                        l = a;
                    0 === r ? (s = 0, i = !0, a = !0) : (s = (t - e.minTranslate()) / r, i = s <= 0, a = s >= 1), Object.assign(e, {
                        progress: s,
                        isBeginning: i,
                        isEnd: a
                    }), (n.watchSlidesProgress || n.centeredSlides && n.autoHeight) && e.updateSlidesProgress(t), i && !o && e.emit("reachBeginning toEdge"), a && !l && e.emit("reachEnd toEdge"), (o && !i || l && !a) && e.emit("fromEdge"), e.emit("progress", s)
                },
                ...
                updateActiveIndex: function(t) {
                    ...
                    let c, u = t;
                    if (void 0 === u) {
                        for (let t = 0; t < r.length; t += 1) void 0 !== r[t + 1] ? n >= r[t] && n < r[t + 1] - (r[t + 1] - r[t]) / 2 ? u = t : n >= r[t] && n < r[t + 1] && (u = t + 1) : n >= r[t] && (u = t);
                    ...
                    if (c >= s.length && (c = s.length - 1), u === a) return void(c !== l && (e.snapIndex = c, e.emit("snapIndexChange")));
                    ...
                    Object.assign(e, {
                        ...
                        previousIndex: a,
                        activeIndex: u
                    }), e.emit("activeIndexChange"), e.emit("snapIndexChange"), o !== p && e.emit("realIndexChange"), (e.initialized || e.params.runCallbacksOnInit) && e.emit("slideChange")
                },
                updateClickedSlide: function(t) {
                    ...
                    e.clickedSlide = r, e.virtual && e.params.virtual.enabled ? e.clickedIndex = parseInt(c(r).attr("data-swiper-slide-index"), 10) : e.clickedIndex = s, n.slideToClickedSlide && void 0 !== e.clickedIndex && e.clickedIndex !== e.activeIndex && e.slideToClickedSlide()
                }
            },
            translate: {
                ...
                setTranslate: function(t, e) {
                    ...
                    let l, c = 0,
                        u = 0;
                    n.isHorizontal() ? c = r ? -t : t : u = t, s.roundLengths && (c = Math.floor(c), u = Math.floor(u)), s.cssMode ? a[n.isHorizontal() ? "scrollLeft" : "scrollTop"] = n.isHorizontal() ? -c : -u : s.virtualTranslate || i.transform(`translate3d(${c}px, ${u}px, 0px)`), n.previousTranslate = n.translate, n.translate = n.isHorizontal() ? c : u;
                    const p = n.maxTranslate() - n.minTranslate();
                    l = 0 === p ? 0 : (t - n.minTranslate()) / p, l !== o && n.updateProgress(t), n.emit("setTranslate", n.translate, e)
                },
                ...
                translateTo: function(t = 0, e = this.params.speed, n = !0, r = !0, s) {
                    ...
                    const l = i.minTranslate(),
                        c = i.maxTranslate();
                    let u;
                    if (u = r && t > l ? l : r && t < c ? c : t, i.updateProgress(u), a.cssMode) {
                        const t = i.isHorizontal();
                        if (0 === e) o[t ? "scrollLeft" : "scrollTop"] = -u;
                        else {
                            if (!i.support.smoothScroll) return v({
                                swiper: i,
                                targetPosition: -u,
                                side: t ? "left" : "top"
                            }), !0;
            ...
            slide: {
                slideTo: function(t = 0, e = this.params.speed, n = !0, r, s) {
                    ...
                    if (i.animating && o.preventInteractionOnTransition || !f && !r && !s) return !1;
                    const m = Math.min(i.params.slidesPerGroupSkip, a);
                    let g = m + Math.floor((a - m) / i.params.slidesPerGroup);
                    g >= l.length && (g = l.length - 1), (p || o.initialSlide || 0) === (u || 0) && n && i.emit("beforeSlideChangeStart");
                    const y = -l[g];
                    ...
                    if (i.initialized && a !== p) {
                        ...
                        if (!i.allowSlidePrev && y > i.translate && y > i.maxTranslate() && (p || 0) !== a) return !1
                    }
                    let b;
                    if (b = a > p ? "next" : a < p ? "prev" : "reset", d && -y === i.translate || !d && y === i.translate) return i.updateActiveIndex(a), o.autoHeight && i.updateAutoHeight(), i.updateSlidesClasses(), "slide" !== o.effect && i.setTranslate(y), "reset" !== b && (i.transitionStart(n, b), i.transitionEnd(n, b)), !1;
                    if (o.cssMode) {
                        const t = i.isHorizontal(),
                            n = d ? y : -y;
                        if (0 === e) {
                            const e = i.virtual && i.params.virtual.enabled;
                            e && (i.wrapperEl.style.scrollSnapType = "none", i._immediateVirtual = !0), h[t ? "scrollLeft" : "scrollTop"] = n, e && requestAnimationFrame(() => {
                    ...
                    return i.setTransition(e), i.setTranslate(y), i.updateActiveIndex(a), i.updateSlidesClasses(), i.emit("beforeTransitionStart", e, r), i.transitionStart(n, b), 0 === e ? i.transitionEnd(n, b) : i.animating || (i.animating = !0, i.onSlideToWrapperTransitionEnd || (i.onSlideToWrapperTransitionEnd = function(t) {
                        i && !i.destroyed && t.target === this && (i.$wrapperEl[0].removeEventListener("transitionend", i.onSlideToWrapperTransitionEnd), i.$wrapperEl[0].removeEventListener("webkitTransitionEnd", i.onSlideToWrapperTransitionEnd), i.onSlideToWrapperTransitionEnd = null, delete i.onSlideToWrapperTransitionEnd, i.transitionEnd(n, b))
                ...
                slidePrev: function(t = this.params.speed, e = !0, n) {
                    ...
                    let f = 0;
                    return void 0 !== h && (f = o.indexOf(h), f < 0 && (f = r.activeIndex - 1), "auto" === s.slidesPerView && 1 === s.slidesPerGroup && s.slidesPerGroupAuto && (f = f - r.slidesPerViewDynamic("previous", !0) + 1, f = Math.max(f, 0))), s.rewind && r.isBeginning ? r.slideTo(r.slides.length - 1, t, e, n) : r.slideTo(f, t, e, n)
                },
                ...
                slideToClosest: function(t = this.params.speed, e = !0, n, r = .5) {
                    ...
                    return i = Math.max(i, 0), i = Math.min(i, s.slidesGrid.length - 1), s.slideTo(i, t, e, n)
                },
                slideToClickedSlide: function() {
                    ...
                    if (e.loop) {
                        ...
                        s = parseInt(c(t.clickedSlide).attr("data-swiper-slide-index"), 10), e.centeredSlides ? i < t.loopedSlides - r / 2 || i > t.slides.length - t.loopedSlides + r / 2 ? (t.loopFix(), i = n.children(`.${e.slideClass}[data-swiper-slide-index="${s}"]:not(.${e.slideDuplicateClass})`).eq(0).index(), p(() => {
                            t.slideTo(i)
                        })) : t.slideTo(i) : i > t.slides.length - r ? (t.loopFix(), i = n.children(`.${e.slideClass}[data-swiper-slide-index="${s}"]:not(.${e.slideDuplicateClass})`).eq(0).index(), p(() => {
                            t.slideTo(i)
                        })) : t.slideTo(i)
                    } else t.slideTo(i)
                }
            ...
            loop: {
                loopCreate: function() {
                    ...
                    "auto" !== n.slidesPerView || n.loopedSlides || (n.loopedSlides = a.length), t.loopedSlides = Math.ceil(parseFloat(n.loopedSlides || n.slidesPerView, 10)), t.loopedSlides += n.loopAdditionalSlides, t.loopedSlides > a.length && (t.loopedSlides = a.length);
                    const o = [],
                        l = [];
                    a.each((e, n) => {
                        const r = c(e);
                        n < t.loopedSlides && l.push(e), n < a.length && n >= a.length - t.loopedSlides && o.push(e), r.attr("data-swiper-slide-index", n)
                    });
                    for (let t = 0; t < l.length; t += 1) i.append(c(l[t].cloneNode(!0)).addClass(n.slideDuplicateClass));
                    for (let t = o.length - 1; t >= 0; t -= 1) i.prepend(c(o[t].cloneNode(!0)).addClass(n.slideDuplicateClass))
                },
                loopFix: function() {
                    const t = this;
                    ...
                    e < r ? (l = n.length - 3 * r + e, l += r, t.slideTo(l, 0, !1, !0) && 0 !== c && t.setTranslate((o ? -t.translate : t.translate) - c)) : e >= n.length - r && (l = -n.length + e + r, l += r, t.slideTo(l, 0, !1, !0) && 0 !== c && t.setTranslate((o ? -t.translate : t.translate) - c)), t.allowSlidePrev = s, t.allowSlideNext = i, t.emit("loopFix")
                },
            ...
            events: {
                attachEvents: function() {
                    ...
                    t.onTouchStart = E.bind(t), t.onTouchMove = k.bind(t), t.onTouchEnd = T.bind(t), n.cssMode && (t.onScroll = M.bind(t)), t.onClick = O.bind(t), s.touch && !A && (e.addEventListener("touchstart", j), A = !0), I(t, "on")
                },
            ...
            breakpoints: {
                setBreakpoint: function() {
                    ...
                    const l = (o in a ? a[o] : void 0) || t.originalParams,
                        ...
                        u = D(t, l),
                        p = s.enabled;
                    c && !u ? (i.removeClass(`${s.containerModifierClass}grid ${s.containerModifierClass}grid-column`), t.emitContainerClasses()) : !c && u && (i.addClass(s.containerModifierClass + "grid"), (l.grid.fill && "column" === l.grid.fill || !l.grid.fill && "column" === s.grid.fill) && i.addClass(s.containerModifierClass + "grid-column"), t.emitContainerClasses());
                    const d = l.direction && l.direction !== s.direction,
                        h = s.loop && (l.slidesPerView !== s.slidesPerView || d);
                    d && n && t.changeDirection(), m(t.params, l);
                    const f = t.params.enabled;
                    Object.assign(t, {
                        allowTouchMove: t.params.allowTouchMove,
                        allowSlideNext: t.params.allowSlideNext,
                        allowSlidePrev: t.params.allowSlidePrev
                    }), p && !f ? t.disable() : !p && f && t.enable(), t.currentBreakpoint = o, t.emit("_beforeBreakpoint", l), h && n && (t.loopDestroy(), t.loopCreate(), t.updateSlides(), t.slideTo(e - r + t.loopedSlides, 0, !1)), t.emit("breakpoint", l)
                },
            ...
            images: {
                loadImage: function(t, e, n, r, s, a) {
                    ...
                    c(t).parent("picture")[0] || t.complete && s ? u() : e ? (l = new o.Image, l.onload = u, l.onerror = u, r && (l.sizes = r), n && (l.srcset = n), e && (l.src = e)) : u()
                },
    ...
    class H {
        constructor(...t) {
            let e, n;
            if (1 === t.length && t[0].constructor && "Object" === Object.prototype.toString.call(t[0]).slice(8, -1) ? n = t[0] : [e, n] = t, n || (n = {}), n = m({}, n), e && !n.el && (n.el = e), n.el && c(n.el).length > 1) {
                const t = [];
            ...
            const r = this;
            r.__swiper__ = !0, r.support = w(), r.device = S({
            ...
            const i = m({}, L, s);
            return r.params = m({}, i, N, n), r.originalParams = m({}, r.params), r.passedParams = m({}, n), r.params && r.params.on && Object.keys(r.params.on).forEach(t => {
        ...
        setProgress(t, e) {
            ...
            n.translateTo(s, void 0 === e ? 0 : e), n.updateActiveIndex(), n.updateSlidesClasses()
        }
        ...
        slidesPerViewDynamic(t = "current", e = !1) {
            ...
            if (n.centeredSlides) {
                ...
                for (let n = o + 1; n < r.length; n += 1) r[n] && !t && (e += r[n].swiperSlideSize, l += 1, e > a && (t = !0));
                for (let n = o - 1; n >= 0; n -= 1) r[n] && !t && (e += r[n].swiperSlideSize, l += 1, e > a && (t = !0))
            } else if ("current" === t)
                for (let t = o + 1; t < r.length; t += 1)(e ? s[t] + i[t] - s[o] < a : s[t] - s[o] < a) && (l += 1);
            else
                for (let t = o - 1; t >= 0; t -= 1) s[o] - s[t] < a && (l += 1);
            return l
        }
        update() {
            const t = this;
            ...
            let s;
            n.breakpoints && t.setBreakpoint(), t.updateSize(), t.updateSlides(), t.updateProgress(), t.updateSlidesClasses(), t.params.freeMode && t.params.freeMode.enabled ? (r(), t.params.autoHeight && t.updateAutoHeight()) : (s = ("auto" === t.params.slidesPerView || t.params.slidesPerView > 1) && t.isEnd && !t.params.centeredSlides ? t.slideTo(t.slides.length - 1, 0, !1, !0) : t.slideTo(t.activeIndex, 0, !1, !0), s || r()), n.watchOverflow && e !== t.snapGrid && t.checkOverflow(), t.emit("update")
        }
        ...
        mount(t) {
            ...
            if (0 === i.length && e.params.createElements) {
                ...
                i = c(t), t.className = e.params.wrapperClass, n.append(t), n.children("." + e.params.slideClass).each(t => {
                    i.append(t)
                })
            }
        ...
        destroy(t = !0, e = !0) {
            ...
            return void 0 === n.params || n.destroyed || (n.emit("beforeDestroy"), n.initialized = !1, n.detachEvents(), r.loop && n.loopDestroy(), e && (n.removeClasses(), s.removeAttr("style"), i.removeAttr("style"), a && a.length && a.removeClass([r.slideVisibleClass, r.slideActiveClass, r.slideNextClass, r.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index")), n.emit("destroy"), Object.keys(n.eventsListeners).forEach(t => {
                n.off(t)
        ...
        static use(t) {
            return Array.isArray(t) ? (t.forEach(t => H.installModule(t)), H) : (H.installModule(t), H)
        }
    }
    ...
    function R(t, e, n, s) {
        ...
        return t.params.createElements && Object.keys(s).forEach(r => {
            if (!n[r] && !0 === n.auto) {
                ...
                a || (a = i.createElement("div"), a.className = s[r], t.$el.append(a)), n[r] = a, e[r] = a
            }
        }), n
    }
    ...
    function W(t) {
        ...
        let a, o = i;
        if ("object" == typeof t && "length" in t) {
            for (let n = 0; n < t.length; n += 1) a = t[n], e.slides[a] && e.slides.eq(a).remove(), a < o && (o -= 1);
            o = Math.max(o, 0)
        } else a = t, e.slides[a] && e.slides.eq(a).remove(), a < o && (o -= 1), o = Math.max(o, 0);
        n.loop && e.loopCreate(), n.observer || e.update(), n.loop ? e.slideTo(o + e.loopedSlides, 0, !1) : e.slideTo(o, 0, !1)
    }
    ...
    function X({
        ...
        if (t.params.virtualTranslate && 0 !== e) {
            let e, o = !1;
            e = r ? n ? s.find(n) : s : n ? s.eq(i).find(n) : s.eq(i), e.transitionEnd(() => {
                if (o) return;
                if (!t || t.destroyed) return;
                o = !0, t.animating = !1;
    ...
    function K(t, e, n) {
        ...
        let i = s.children("." + r);
        return i.length || (i = c(`<div class="swiper-slide-shadow${n?"-"+n:""}"></div>`), s.append(i)), i
    }
        ...
        e("init", () => {
            t.params.resizeObserver && void 0 !== r.ResizeObserver ? t && !t.destroyed && t.initialized && (s = new ResizeObserver(e => {
                ...
                e.forEach(({
                    ...
                    r && r !== t.el || (s = n ? n.width : (e[0] || e).inlineSize, i = n ? n.height : (e[0] || e).blockSize)
                }), s === n && i === r || a()
            }), s.observe(t.el)) : (r.addEventListener("resize", a), r.addEventListener("orientationchange", o))
        }), e("destroy", () => {
            s && s.unobserve && t.el && (s.unobserve(t.el), s = null), r.removeEventListener("resize", a), r.removeEventListener("orientationchange", o)
        })
    }, function({
        swiper: t,
        extendParams: e,
    ...
    const Q = [function({
        ...
        function s(e, n) {
            ...
            if (r.cache && t.virtual.cache[n]) return t.virtual.cache[n];
            const s = r.renderSlide ? c(r.renderSlide.call(t, e, n)) : c(`<div class="${t.params.slideClass}" data-swiper-slide-index="${n}">${e}</div>`);
            return s.attr("data-swiper-slide-index") || s.attr("data-swiper-slide-index", n), r.cache && (t.virtual.cache[n] = s), s
        }
        ...
        function i(e) {
            ...
            if (Object.assign(t.virtual, {
                ...
                }), l === v && c === y && !e) return t.slidesGrid !== p && b !== d && t.slides.css(f, b + "px"), void t.updateProgress();
            if (t.params.virtual.renderExternal) return t.params.virtual.renderExternal.call(t, {
                ...
                slides: function() {
                    const t = [];
                    for (let e = v; e <= y; e += 1) t.push(u[e]);
                    return t
                }()
            ...
            if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();
                ...
                for (let e = l; e <= c; e += 1)(e < v || e > y) && t.$wrapperEl.find(`.${t.params.slideClass}[data-swiper-slide-index="${e}"]`).remove();
            for (let t = 0; t < u.length; t += 1) t >= v && t <= y && (void 0 === c || e ? S.push(t) : (t > c && S.push(t), t < l && w.push(t)));
            S.forEach(e => {
                t.$wrapperEl.append(s(u[e], e))
            }), w.sort((t, e) => e - t).forEach(e => {
                t.$wrapperEl.prepend(s(u[e], e))
            }), t.$wrapperEl.children(".swiper-slide").css(f, b + "px"), _()
        }
        e({
            virtual: {
                enabled: !1,
            ...
            t.params.virtual.enabled && (t.virtual.slides = t.params.virtual.slides, t.classNames.push(t.params.containerModifierClass + "virtual"), t.params.watchSlidesProgress = !0, t.originalParams.watchSlidesProgress = !0, t.params.initialSlide || i())
        }), n("setTranslate", () => {
            t.params.virtual.enabled && (t.params.cssMode && !t._immediateVirtual ? (clearTimeout(r), r = setTimeout(() => {
                i()
            }, 100)) : i())
            ...
            prependSlide: function(e) {
                ...
                if (t.params.virtual.cache) {
                    ...
                    Object.keys(e).forEach(t => {
                        ...
                        i && r.attr("data-swiper-slide-index", parseInt(i, 10) + s), n[parseInt(t, 10) + s] = r
                    }), t.virtual.cache = n
                }
                i(!0), t.slideTo(r, 0)
            },
            ...
            removeAllSlides: function() {
                t.virtual.slides = [], t.params.virtual.cache && (t.virtual.cache = {}), i(!0), t.slideTo(0, 0)
            },
            update: i
        })
    }, function({
        ...
        function l(e) {
            ...
            if (!(r.shiftKey || r.altKey || r.ctrlKey || r.metaKey || a.activeElement && a.activeElement.nodeName && ("input" === a.activeElement.nodeName.toLowerCase() || "textarea" === a.activeElement.nodeName.toLowerCase()))) {
                ...
                t.isHorizontal() ? ((c || u || p || d) && (r.preventDefault ? r.preventDefault() : r.returnValue = !1), ((u || d) && !n || (c || p) && n) && t.slideNext(), ((c || p) && !n || (u || d) && n) && t.slidePrev()) : ((c || u || h || f) && (r.preventDefault ? r.preventDefault() : r.returnValue = !1), (u || f) && t.slideNext(), (c || h) && t.slidePrev()), s("keyPress", i)
            }
        }

        function u() {
            t.keyboard.enabled || (c(a).on("keydown", l), t.keyboard.enabled = !0)
        }

        function p() {
            t.keyboard.enabled && (c(a).off("keydown", l), t.keyboard.enabled = !1)
        }
        t.keyboard = {
            enabled: !1
        }, e({
        ...
        function m(e) {
            return !(t.params.mousewheel.thresholdDelta && e.delta < t.params.mousewheel.thresholdDelta || t.params.mousewheel.thresholdTime && d() - l < t.params.mousewheel.thresholdTime || !(e.delta >= 6 && d() - l < 60) && (e.direction < 0 ? t.isEnd && !t.params.loop || t.animating || (t.slideNext(), r("scroll", e.raw)) : t.isBeginning && !t.params.loop || t.animating || (t.slidePrev(), r("scroll", e.raw)), l = (new s.Date).getTime(), 1))
        }
        ...
        function g(e) {
            ...
            let l = t.$el;
            if ("container" !== t.params.mousewheel.eventsTarget && (l = c(t.params.mousewheel.eventsTarget)), !t.mouseEntered && !l[0].contains(n.target) && !i.releaseOnEdges) return !0;
            ...
            const f = t.rtlTranslate ? -1 : 1,
                g = function(t) {
                    let e = 0,
                        ...
                        r = 0,
                        s = 0;
                    return "detail" in t && (n = t.detail), "wheelDelta" in t && (n = -t.wheelDelta / 120), "wheelDeltaY" in t && (n = -t.wheelDeltaY / 120), "wheelDeltaX" in t && (e = -t.wheelDeltaX / 120), "axis" in t && t.axis === t.HORIZONTAL_AXIS && (e = n, n = 0), r = 10 * e, s = 10 * n, "deltaY" in t && (s = t.deltaY), "deltaX" in t && (r = t.deltaX), t.shiftKey && !r && (r = s, s = 0), (r || s) && t.deltaMode && (1 === t.deltaMode ? (r *= 40, s *= 40) : (r *= 800, s *= 800)), r && !e && (e = r < 1 ? -1 : 1), s && !n && (n = s < 1 ? -1 : 1), {
                        spinX: e,
                        spinY: n,
                        pixelX: r,
                        pixelY: s
            ...
            if (v >= t.minTranslate() && (v = t.minTranslate()), v <= t.maxTranslate() && (v = t.maxTranslate()), s = !!t.params.loop || !(v === t.minTranslate() || v === t.maxTranslate()), s && t.params.nested && n.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
                const e = {
                        time: d(),
                        delta: Math.abs(h),
                ...
                if (!s) {
                    ...
                    const c = t.isBeginning,
                        d = t.isEnd;
                    if (l >= t.minTranslate() && (l = t.minTranslate()), l <= t.maxTranslate() && (l = t.maxTranslate()), t.setTransition(0), t.setTranslate(l), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), (!c && t.isBeginning || !d && t.isEnd) && t.updateSlidesClasses(), t.params.freeMode.sticky) {
                        clearTimeout(a), a = void 0, u.length >= 15 && u.shift();
                        const n = u.length ? u[u.length - 1] : void 0,
                            r = u[0];
                        if (u.push(e), n && (e.delta > n.delta || e.direction !== n.direction)) u.splice(0);
                    ...
                    if (s || r("scroll", n), t.params.autoplay && t.params.autoplayDisableOnInteraction && t.autoplay.stop(), l === t.minTranslate() || l === t.maxTranslate()) return !0
                }
            } else {
                const n = {
                    time: d(),
                ...
                if (u.push(n), r ? (n.direction !== r.direction || n.delta > r.delta || n.time > r.time + 150) && m(n) : m(n), function(e) {
        ...
        function v(e) {
            let n = t.$el;
            "container" !== t.params.mousewheel.eventsTarget && (n = c(t.params.mousewheel.eventsTarget)), n[e]("mouseenter", h), n[e]("mouseleave", f), n[e]("wheel", g)
        }
        ...
        function u() {
            ...
            const n = s(e.nextEl),
                r = s(e.prevEl);
            n && n.length > 0 && n.on("click", l), r && r.length > 0 && r.on("click", o), Object.assign(t.navigation, {
                $nextEl: n,
                nextEl: n && n[0],
                $prevEl: r,
                prevEl: r && r[0]
        ...
        function p() {
            ...
            e && e.length && (e.off("click", l), e.removeClass(t.params.navigation.disabledClass)), n && n.length && (n.off("click", o), n.removeClass(t.params.navigation.disabledClass))
        }
        e({
            navigation: {
                nextEl: null,
            ...
            if (t.params.navigation.hideOnClick && !c(a).is(i) && !c(a).is(s)) {
                ...
                let e;
                s ? e = s.hasClass(t.params.navigation.hiddenClass) : i && (e = i.hasClass(t.params.navigation.hiddenClass)), r(!0 === e ? "navigationShow" : "navigationHide"), s && s.toggleClass(t.params.navigation.hiddenClass), i && i.toggleClass(t.params.navigation.hiddenClass)
            }
        ...
        function u() {
            ...
            if (t.params.loop ? (p = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup), p > s - 1 - 2 * t.loopedSlides && (p -= s - 2 * t.loopedSlides), p > d - 1 && (p -= d), p < 0 && "bullets" !== t.params.paginationType && (p = d + p)) : p = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0, "bullets" === n.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                const r = t.pagination.bullets;
                let s, o, d;
                if (n.dynamicBullets && (i = r.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0), u.css(t.isHorizontal() ? "width" : "height", i * (n.dynamicMainBullets + 4) + "px"), n.dynamicMainBullets > 1 && void 0 !== t.previousIndex && (a += p - (t.previousIndex - t.loopedSlides || 0), a > n.dynamicMainBullets - 1 ? a = n.dynamicMainBullets - 1 : a < 0 && (a = 0)), s = Math.max(p - a, 0), o = s + (Math.min(r.length, n.dynamicMainBullets) - 1), d = (o + s) / 2), r.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(t => `${n.bulletActiveClass}${t}`).join(" ")), u.length > 1) r.each(t => {
                    const e = c(t),
                        r = e.index();
                    r === p && e.addClass(n.bulletActiveClass), n.dynamicBullets && (r >= s && r <= o && e.addClass(n.bulletActiveClass + "-main"), r === s && l(e, "prev"), r === o && l(e, "next"))
                });
                else {
                    const e = r.eq(p),
                        i = e.index();
                    if (e.addClass(n.bulletActiveClass), n.dynamicBullets) {
                        const e = r.eq(s),
                            a = r.eq(o);
                        for (let t = s; t <= o; t += 1) r.eq(t).addClass(n.bulletActiveClass + "-main");
                        if (t.params.loop)
                            if (i >= r.length) {
            ...
            if ("fraction" === n.type && (u.find(z(n.currentClass)).text(n.formatFractionCurrent(p + 1)), u.find(z(n.totalClass)).text(n.formatFractionTotal(d))), "progressbar" === n.type) {
                let e;
                e = n.progressbarOpposite ? t.isHorizontal() ? "vertical" : "horizontal" : t.isHorizontal() ? "horizontal" : "vertical";
                const r = (p + 1) / d;
                let s = 1,
                    i = 1;
                "horizontal" === e ? s = r : i = r, u.find(z(n.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${s}) scaleY(${i})`).transition(t.params.speed)
            }
            "custom" === n.type && n.renderCustom ? (u.html(n.renderCustom(t, p + 1, d)), r("paginationRender", u[0])) : r("paginationUpdate", u[0]), t.params.watchOverflow && t.enabled && u[t.isLocked ? "addClass" : "removeClass"](n.lockClass)
        }
        ...
        function p() {
            ...
            if ("bullets" === e.type) {
                ...
                for (let n = 0; n < r; n += 1) e.renderBullet ? i += e.renderBullet.call(t, n, e.bulletClass) : i += `<${e.bulletElement} class="${e.bulletClass}"></${e.bulletElement}>`;
                s.html(i), t.pagination.bullets = s.find(z(e.bulletClass))
            }
            "fraction" === e.type && (i = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : `<span class="${e.currentClass}"></span> / <span class="${e.totalClass}"></span>`, s.html(i)), "progressbar" === e.type && (i = e.renderProgressbar ? e.renderProgressbar.call(t, e.progressbarFillClass) : `<span class="${e.progressbarFillClass}"></span>`, s.html(i)), "custom" !== e.type && r("paginationRender", t.pagination.$el[0])
        }
        ...
        function h() {
            ...
            n.removeClass(e.hiddenClass), n.removeClass(e.modifierClass + e.type), n.removeClass(e.modifierClass + t.params.direction), t.pagination.bullets && t.pagination.bullets.removeClass && t.pagination.bullets.removeClass(e.bulletActiveClass), e.clickable && n.off("click", z(e.bulletClass))
        }
        n("init", () => {
            d(), p(), u()
        }), n("activeIndexChange", () => {
            ...
            if (t.params.pagination.el && t.params.pagination.hideOnClick && i.length > 0 && !c(s).hasClass(t.params.pagination.bulletClass)) {
                ...
                r(!0 === e ? "paginationShow" : "paginationHide"), i.toggleClass(t.params.pagination.hiddenClass)
            }
        }), Object.assign(t.pagination, {
            render: p,
            update: u,
        ...
        function m() {
            ...
            let c = o,
                u = (l - o) * r;
            n ? (u = -u, u > 0 ? (c = o - u, u = 0) : -u + o > l && (c = l + u)) : u < 0 ? (c = o + u, u = 0) : u + o > l && (c = l - u), t.isHorizontal() ? (s.transform(`translate3d(${u}px, 0, 0)`), s[0].style.width = c + "px") : (s.transform(`translate3d(0px, ${u}px, 0)`), s[0].style.height = c + "px"), a.hide && (clearTimeout(h), i[0].style.opacity = 1, h = setTimeout(() => {
        ...
        function g() {
            ...
            n[0].style.width = "", n[0].style.height = "", l = t.isHorizontal() ? r[0].offsetWidth : r[0].offsetHeight, u = t.size / (t.virtualSize + t.params.slidesOffsetBefore - (t.params.centeredSlides ? t.snapGrid[0] : 0)), o = "auto" === t.params.scrollbar.dragSize ? l * u : parseInt(t.params.scrollbar.dragSize, 10), t.isHorizontal() ? n[0].style.width = o + "px" : n[0].style.height = o + "px", r[0].style.display = u >= 1 ? "none" : "", t.params.scrollbar.hide && (r[0].style.opacity = 0), t.params.watchOverflow && t.enabled && e.$el[t.isLocked ? "addClass" : "removeClass"](t.params.scrollbar.lockClass)
        }
        ...
        function y(e) {
            ...
            let i;
            i = (v(e) - s.offset()[t.isHorizontal() ? "left" : "top"] - (null !== a ? a : o / 2)) / (l - o), i = Math.max(Math.min(i, 1), 0), r && (i = 1 - i);
        ...
        function b(e) {
            ...
            d = !0, a = e.target === l[0] || e.target === l ? v(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null, e.preventDefault(), e.stopPropagation(), i.transition(100), l.transition(100), y(e), clearTimeout(f), o.transition(0), n.hide && o.css("opacity", 1), t.params.cssMode && t.$wrapperEl.css("scroll-snap-type", "none"), s("scrollbarDragStart", e)
        }
        ...
        function _(e) {
            ...
            d && (e.preventDefault ? e.preventDefault() : e.returnValue = !1, y(e), r.transition(0), i.transition(0), a.transition(0), s("scrollbarDragMove", e))
        }
        ...
        function w(e) {
            ...
            d && (d = !1, t.params.cssMode && (t.$wrapperEl.css("scroll-snap-type", ""), i.transition("")), n.hide && (clearTimeout(f), f = p(() => {
        ...
        function S(e) {
            const {
                ...
                params: a,
                support: o
            } = t, l = n.$el[0], c = !(!o.passiveListener || !a.passiveListeners) && {
                passive: !1,
                capture: !1
            ...
            o.touch ? (l[p](r.start, b, c), l[p](r.move, _, c), l[p](r.end, w, u)) : (l[p](s.start, b, c), i[p](s.move, _, c), i[p](s.end, w, u))
        }
        ...
        function C() {
            ...
            0 === i.length && (i = c(`<div class="${t.params.scrollbar.dragClass}"></div>`), s.append(i)), Object.assign(e, {
                $el: s,
                el: s[0],
                $dragEl: i,
                dragEl: i[0]
            }), r.draggable && t.params.scrollbar.el && S("on"), s && s[t.enabled ? "removeClass" : "addClass"](t.params.scrollbar.lockClass)
        }
        ...
        const r = (e, n) => {
                const {
                    rtl: r
                } = t, s = c(e), i = r ? -1 : 1, a = s.attr("data-swiper-parallax") || "0";
                let o = s.attr("data-swiper-parallax-x"),
                    l = s.attr("data-swiper-parallax-y");
                const u = s.attr("data-swiper-parallax-scale"),
                    p = s.attr("data-swiper-parallax-opacity");
                if (o || l ? (o = o || "0", l = l || "0") : t.isHorizontal() ? (o = a, l = "0") : (l = a, o = "0"), o = o.indexOf("%") >= 0 ? parseInt(o, 10) * n * i + "%" : o * n * i + "px", l = l.indexOf("%") >= 0 ? parseInt(l, 10) * n + "%" : l * n + "px", null != p) {
            ...
            s = () => {
                ...
                e.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(t => {
                    ...
                    let a = e.progress;
                    t.params.slidesPerGroup > 1 && "auto" !== t.params.slidesPerView && (a += Math.ceil(n / 2) - s * (i.length - 1)), a = Math.min(Math.max(a, -1), 1), c(e).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(t => {
                        r(t, a)
                    })
                })
            };
        ...
        function y(e) {
            ...
            if (o = !1, l = !1, !n.gestures) {
                ...
                o = !0, d.scaleStart = v(e)
            }
            d.$slideEl && d.$slideEl.length || (d.$slideEl = c(e.target).closest("." + t.params.slideClass), 0 === d.$slideEl.length && (d.$slideEl = t.slides.eq(t.activeIndex)), d.$imageEl = d.$slideEl.find("." + r.containerClass).eq(0).find("picture, img, svg, canvas, .swiper-zoom-target").eq(0), d.$imageWrapEl = d.$imageEl.parent("." + r.containerClass), d.maxRatio = d.$imageWrapEl.attr("data-swiper-zoom") || r.maxRatio, 0 !== d.$imageWrapEl.length) ? (d.$imageEl && d.$imageEl.transition(0), p = !0) : d.$imageEl = void 0
        }
        ...
        function b(e) {
            ...
            d.$imageEl && 0 !== d.$imageEl.length ? (n.gestures ? s.scale = e.scale * u : s.scale = d.scaleMove / d.scaleStart * u, s.scale > d.maxRatio && (s.scale = d.maxRatio - 1 + (s.scale - d.maxRatio + 1) ** .5), s.scale < r.minRatio && (s.scale = r.minRatio + 1 - (r.minRatio - s.scale + 1) ** .5), d.$imageEl.transform(`translate3d(0,0,0) scale(${s.scale})`)) : "gesturechange" === e.type && y(e)
        }
        ...
        function _(e) {
            ...
            d.$imageEl && 0 !== d.$imageEl.length && (i.scale = Math.max(Math.min(i.scale, d.maxRatio), s.minRatio), d.$imageEl.transition(t.params.speed).transform(`translate3d(0,0,0) scale(${i.scale})`), u = i.scale, p = !1, 1 === i.scale && (d.$slideEl = void 0))
        }

        function w(e) {
            const n = t.zoom;
            if (!d.$imageEl || 0 === d.$imageEl.length) return;
            if (t.allowClick = !1, !f.isTouched || !d.$slideEl) return;
            f.isMoved || (f.width = d.$imageEl[0].offsetWidth, f.height = d.$imageEl[0].offsetHeight, f.startX = h(d.$imageWrapEl[0], "x") || 0, f.startY = h(d.$imageWrapEl[0], "y") || 0, d.slideWidth = d.$slideEl[0].offsetWidth, d.slideHeight = d.$slideEl[0].offsetHeight, d.$imageWrapEl.transition(0));
            const r = f.width * n.scale,
                s = f.height * n.scale;
            if (!(r < d.slideWidth && s < d.slideHeight)) {
                if (f.minX = Math.min(d.slideWidth / 2 - r / 2, 0), f.maxX = -f.minX, f.minY = Math.min(d.slideHeight / 2 - s / 2, 0), f.maxY = -f.minY, f.touchesCurrent.x = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, f.touchesCurrent.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, !f.isMoved && !p) {
        ...
        function S() {
            const e = t.zoom;
            d.$slideEl && t.previousIndex !== t.activeIndex && (d.$imageEl && d.$imageEl.transform("translate3d(0,0,0) scale(1)"), d.$imageWrapEl && d.$imageWrapEl.transform("translate3d(0,0,0)"), e.scale = 1, u = 1, d.$slideEl = void 0, d.$imageEl = void 0, d.$imageWrapEl = void 0)
        }

        function C(e) {
            const n = t.zoom,
                r = t.params.zoom;
            if (d.$slideEl || (e && e.target && (d.$slideEl = c(e.target).closest("." + t.params.slideClass)), d.$slideEl || (t.params.virtual && t.params.virtual.enabled && t.virtual ? d.$slideEl = t.$wrapperEl.children("." + t.params.slideActiveClass) : d.$slideEl = t.slides.eq(t.activeIndex)), d.$imageEl = d.$slideEl.find("." + r.containerClass).eq(0).find("picture, img, svg, canvas, .swiper-zoom-target").eq(0), d.$imageWrapEl = d.$imageEl.parent("." + r.containerClass)), !d.$imageEl || 0 === d.$imageEl.length || !d.$imageWrapEl || 0 === d.$imageWrapEl.length) return;
            let i, a, o, l, p, h, m, g, v, y, b, _, w, S, C, x, E, k;
            t.params.cssMode && (t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.touchAction = "none"), d.$slideEl.addClass("" + r.zoomedSlideClass), void 0 === f.touchesStart.x && e ? (i = "touchend" === e.type ? e.changedTouches[0].pageX : e.pageX, a = "touchend" === e.type ? e.changedTouches[0].pageY : e.pageY) : (i = f.touchesStart.x, a = f.touchesStart.y), n.scale = d.$imageWrapEl.attr("data-swiper-zoom") || r.maxRatio, u = d.$imageWrapEl.attr("data-swiper-zoom") || r.maxRatio, e ? (E = d.$slideEl[0].offsetWidth, k = d.$slideEl[0].offsetHeight, o = d.$slideEl.offset().left + s.scrollX, l = d.$slideEl.offset().top + s.scrollY, p = o + E / 2 - i, h = l + k / 2 - a, v = d.$imageEl[0].offsetWidth, y = d.$imageEl[0].offsetHeight, b = v * n.scale, _ = y * n.scale, w = Math.min(E / 2 - b / 2, 0), S = Math.min(k / 2 - _ / 2, 0), C = -w, x = -S, m = p * n.scale, g = h * n.scale, m < w && (m = w), m > C && (m = C), g < S && (g = S), g > x && (g = x)) : (m = 0, g = 0), d.$imageWrapEl.transition(300).transform(`translate3d(${m}px, ${g}px,0)`), d.$imageEl.transition(300).transform(`translate3d(0,0,0) scale(${n.scale})`)
        }
        ...
        function P(e) {
            ...
            t.$wrapperEl[e]("gesturestart", r, y, n), t.$wrapperEl[e]("gesturechange", r, b, n), t.$wrapperEl[e]("gestureend", r, _, n)
        }
        ...
        function A() {
            ...
            const n = t.support,
                ...
                i = T();
            n.gestures ? (t.$wrapperEl.on(t.touchEvents.start, O, r), t.$wrapperEl.on(t.touchEvents.end, M, r)) : "touchstart" === t.touchEvents.start && (t.$wrapperEl.on(t.touchEvents.start, i, y, r), t.$wrapperEl.on(t.touchEvents.move, i, b, s), t.$wrapperEl.on(t.touchEvents.end, i, _, r), t.touchEvents.cancel && t.$wrapperEl.on(t.touchEvents.cancel, i, _, r)), t.$wrapperEl.on(t.touchEvents.move, "." + t.params.zoom.containerClass, w, s)
        }
        ...
        function j() {
            ...
            n.gestures ? (t.$wrapperEl.off(t.touchEvents.start, O, r), t.$wrapperEl.off(t.touchEvents.end, M, r)) : "touchstart" === t.touchEvents.start && (t.$wrapperEl.off(t.touchEvents.start, i, y, r), t.$wrapperEl.off(t.touchEvents.move, i, b, s), t.$wrapperEl.off(t.touchEvents.end, i, _, r), t.touchEvents.cancel && t.$wrapperEl.off(t.touchEvents.cancel, i, _, r)), t.$wrapperEl.off(t.touchEvents.move, "." + t.params.zoom.containerClass, w, s)
        }
        Object.defineProperty(t.zoom, "scale", {
            ...
            t.zoom.enabled && function(e) {
                const n = t.device;
                d.$imageEl && 0 !== d.$imageEl.length && (f.isTouched || (n.android && e.cancelable && e.preventDefault(), f.isTouched = !0, f.touchesStart.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, f.touchesStart.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY))
            }(n)
        }), n("touchEnd", (e, n) => {
            t.zoom.enabled && function() {
                ...
                const s = m.x * n,
                    ...
                    a = m.y * r,
                    o = f.currentY + a;
                0 !== m.x && (n = Math.abs((i - f.currentX) / m.x)), 0 !== m.y && (r = Math.abs((o - f.currentY) / m.y));
        ...
        function o(e, n = !0) {
            ...
            !i.hasClass(s.elementClass) || i.hasClass(s.loadedClass) || i.hasClass(s.loadingClass) || a.push(i[0]), 0 !== a.length && a.each(e => {
                const a = c(e);
                ...
                t.loadImage(a[0], u || l, p, d, !1, () => {
                    if (null != t && t && (!t || t.params) && !t.destroyed) {
                        if (l ? (a.css("background-image", `url("${l}")`), a.removeAttr("data-background")) : (p && (a.attr("srcset", p), a.removeAttr("data-srcset")), d && (a.attr("sizes", d), a.removeAttr("data-sizes")), h.length && h.children("source").each(t => {
                                const e = c(t);
                                e.attr("data-srcset") && (e.attr("srcset", e.attr("data-srcset")), e.removeAttr("data-srcset"))
                            }), u && (a.attr("src", u), a.removeAttr("data-src"))), a.addClass(s.loadedClass).removeClass(s.loadingClass), i.find("." + s.preloaderClass).remove(), t.params.loop && n) {
                        ...
                        r("lazyImageReady", i[0], a[0]), t.params.autoHeight && t.updateAutoHeight()
                    }
        ...
        function l() {
            const {
                ...
                slides: r,
                activeIndex: s
            } = t, i = t.virtual && n.virtual.enabled, l = n.lazy;
            ...
            if ("auto" === u && (u = 0), a || (a = !0), t.params.watchSlidesProgress) e.children("." + n.slideVisibleClass).each(t => {
                o(i ? c(t).attr("data-swiper-slide-index") : c(t).index())
            });
            else if (u > 1)
                for (let t = s; t < s + u; t += 1) p(t) && o(t);
            else o(s);
            if (l.loadPrevNext)
                if (u > 1 || l.loadPrevNextAmount && l.loadPrevNextAmount > 1) {
                    ...
                    for (let t = s + u; t < n; t += 1) p(t) && o(t);
                    for (let t = i; t < s; t += 1) p(t) && o(t)
                } else {
        ...
        function u() {
            ...
            h ? (l(), n.off("scroll", u, m)) : s || (s = !0, n.on("scroll", u, m))
        }
        n("beforeInit", () => {
        ...
        function r(t, e) {
            const n = function() {
                let t, e, n;
                return (r, s) => {
                    for (e = -1, t = r.length; t - e > 1;) n = t + e >> 1, r[n] <= s ? e = n : t = n;
                    return t
                }
            }();
            let r, s;
            return this.x = t, this.y = e, this.lastIndex = t.length - 1, this.interpolate = function(t) {
                return t ? (s = n(this.x, t), r = s - 1, (t - this.x[r]) * (this.y[s] - this.y[r]) / (this.x[s] - this.x[r]) + this.y[r]) : 0
            }, this
        }
        ...
        e({
            ...
            setTranslate: function(e, n) {
                ...
                function l(e) {
                    ...
                    }(e), a = -t.controller.spline.interpolate(-n)), a && "container" !== t.params.controller.by || (i = (e.maxTranslate() - e.minTranslate()) / (t.maxTranslate() - t.minTranslate()), a = (n - t.minTranslate()) * i + e.minTranslate()), t.params.controller.inverse && (a = e.maxTranslate() - a), e.updateProgress(a), e.setTranslate(a, t), e.updateActiveIndex(), e.updateSlidesClasses()
                }
                if (Array.isArray(s))
                    for (let t = 0; t < s.length; t += 1) s[t] !== n && s[t] instanceof o && l(s[t]);
            ...
            setTransition: function(e, n) {
                ...
                function a(n) {
                    n.setTransition(e, t), 0 !== e && (n.transitionStart(), n.params.autoHeight && p(() => {
                        n.updateAutoHeight()
                ...
                if (Array.isArray(s))
                    for (i = 0; i < s.length; i += 1) s[i] !== n && s[i] instanceof r && a(s[i]);
        ...
        function f() {
            ...
            n && n.length > 0 && (t.isBeginning ? (p(n), a(n)) : (d(n), i(n))), e && e.length > 0 && (t.isEnd ? (p(e), a(e)) : (d(e), i(e)))
        }
        ...
        const v = (t, e, n) => {
            i(t), "BUTTON" !== t[0].tagName && (o(t, "button"), t.on("keydown", h)), u(t, n),
                function(t, e) {
        ...
        n("beforeInit", () => {
            ...
            t.params.a11y.enabled && (function() {
                ...
                t.$el.append(r);
                const n = t.$el;
                e.containerRoleDescriptionMessage && l(n, e.containerRoleDescriptionMessage), e.containerMessage && u(n, e.containerMessage);
                const s = t.$wrapperEl,
                ...
                p = i, s.attr("id", p),
                    function(t, e) {
                        t.attr("aria-live", e)
                    }(s, a), e.itemRoleDescriptionMessage && l(c(t.slides), e.itemRoleDescriptionMessage), o(c(t.slides), e.slideRole);
                ...
                }), t.navigation && t.navigation.$nextEl && (f = t.navigation.$nextEl), t.navigation && t.navigation.$prevEl && (m = t.navigation.$prevEl), f && f.length && v(f, i, e.nextSlideMessage), m && m.length && v(m, i, e.prevSlideMessage), g() && t.pagination.$el.on("keydown", z(t.params.pagination.bulletClass), h)
            }(), f())
        }), n("toEdge", () => {
            ...
            t.params.a11y.enabled && function() {
                ...
                m() && t.pagination.bullets.each(n => {
                    const r = c(n);
                    t.params.pagination.clickable && (i(r), t.params.pagination.renderBullet || (o(r, "button"), u(r, e.paginationBulletMessage.replace(/\{\{index\}\}/, r.index() + 1)))), r.is("." + t.params.pagination.bulletActiveClass) ? r.attr("aria-current", "true") : r.removeAttr("aria-current")
                })
            }()
        }), n("destroy", () => {
            t.params.a11y.enabled && function() {
                let e, n;
                r && r.length > 0 && r.remove(), t.navigation && t.navigation.$nextEl && (e = t.navigation.$nextEl), t.navigation && t.navigation.$prevEl && (n = t.navigation.$prevEl), e && e.off("keydown", h), n && n.off("keydown", h), g() && t.pagination.$el.off("keydown", z(t.params.pagination.bulletClass), h)
            }()
        })
    }, function({
        swiper: t,
        ...
        const a = t => t.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, ""),
            ...
            u = () => {
                s = o(t.params.url), c(t.params.speed, t.paths.value, !1)
            };
        n("init", () => {
            t.params.history.enabled && (() => {
                ...
                if (t.params.history) {
                    ...
                    r = !0, s = o(t.params.url), (s.key || s.value) && (c(0, s.value, t.params.runCallbacksOnInit), t.params.history.replaceState || e.addEventListener("popstate", u))
                }
            })()
        }), n("destroy", () => {
            t.params.history.enabled && (() => {
        ...
        const u = () => {
            ...
            p = () => {
                if (a && t.params.hashNavigation.enabled)
                    if (t.params.hashNavigation.replaceState && l.history && l.history.replaceState) l.history.replaceState(null, null, "#" + t.slides.eq(t.activeIndex).attr("data-hash") || ""), n("hashSet");
                    else {
        ...
        function a() {
            ...
            e.attr("data-swiper-autoplay") && (n = e.attr("data-swiper-autoplay") || t.params.autoplay.delay), clearTimeout(i), i = p(() => {
                let e;
                t.params.autoplay.reverseDirection ? t.params.loop ? (t.loopFix(), e = t.slidePrev(t.params.speed, !0, !0), s("autoplay")) : t.isBeginning ? t.params.autoplay.stopOnLastSlide ? l() : (e = t.slideTo(t.slides.length - 1, t.params.speed, !0, !0), s("autoplay")) : (e = t.slidePrev(t.params.speed, !0, !0), s("autoplay")) : t.params.loop ? (t.loopFix(), e = t.slideNext(t.params.speed, !0, !0), s("autoplay")) : t.isEnd ? t.params.autoplay.stopOnLastSlide ? l() : (e = t.slideTo(0, t.params.speed, !0, !0), s("autoplay")) : (e = t.slideNext(t.params.speed, !0, !0), s("autoplay")), (t.params.cssMode && t.autoplay.running || !1 === e) && a()
            }, n)
        }

        function o() {
            return void 0 === i && !t.autoplay.running && (t.autoplay.running = !0, s("autoplayStart"), a(), !0)
        }

        function l() {
            return !!t.autoplay.running && void 0 !== i && (i && (clearTimeout(i), i = void 0), t.autoplay.running = !1, s("autoplayStop"), !0)
        }

        function c(e) {
            t.autoplay.running && (t.autoplay.paused || (i && clearTimeout(i), t.autoplay.paused = !0, 0 !== e && t.params.autoplay.waitForTransition ? ["transitionend", "webkitTransitionEnd"].forEach(e => {
                t.$wrapperEl[0].addEventListener(e, d)
            }) : (t.autoplay.paused = !1, a())))
        }

        function u() {
            const e = r();
            "hidden" === e.visibilityState && t.autoplay.running && c(), "visible" === e.visibilityState && t.autoplay.paused && (a(), t.autoplay.paused = !1)
        }
        ...
        function d(e) {
            ...
            }), t.autoplay.paused = !1, t.autoplay.running ? a() : l())
        }

        function h() {
            t.params.autoplay.disableOnInteraction ? l() : c(), ["transitionend", "webkitTransitionEnd"].forEach(e => {
                t.$wrapperEl[0].removeEventListener(e, d)
            })
        }

        function f() {
            t.params.autoplay.disableOnInteraction || (t.autoplay.paused = !1, a())
        }
        t.autoplay = {
            running: !1,
            paused: !1
            ...
            t.params.autoplay.enabled && (o(), r().addEventListener("visibilitychange", u), t.params.autoplay.pauseOnMouseEnter && (t.$el.on("mouseenter", h), t.$el.on("mouseleave", f)))
            ...
            t.$el.off("mouseenter", h), t.$el.off("mouseleave", f), t.autoplay.running && l(), r().removeEventListener("visibilitychange", u)
        ...
        function a() {
            ...
            if (e.swiper instanceof n) t.thumbs.swiper = e.swiper, Object.assign(t.thumbs.swiper.originalParams, {
                ...
                Object.assign(r, {
                    watchSlidesProgress: !0,
                    slideToClickedSlide: !1
                }), t.thumbs.swiper = new n(r), s = !0
            }
            return t.thumbs.swiper.$el.addClass(t.params.thumbs.thumbsContainerClass), t.thumbs.swiper.on("tap", i), !0
        }
        ...
        function o(e) {
            ...
            if (t.realIndex !== n.realIndex || i) {
                ...
                if (n.params.loop) {
                    ...
                    a = void 0 === e ? r : void 0 === r ? e : r - l == l - e ? n.params.slidesPerGroup > 1 ? r : l : r - l < l - e ? r : e, o = t.activeIndex > t.previousIndex ? "next" : "prev"
                } else a = t.realIndex, o = a > t.previousIndex ? "next" : "prev";
                i && (a += "next" === o ? s : -1 * s), n.visibleSlidesIndexes && n.visibleSlidesIndexes.indexOf(a) < 0 && (n.params.centeredSlides ? a = a > l ? a - Math.floor(r / 2) + 1 : a + Math.floor(r / 2) - 1 : a > l && n.params.slidesPerGroup, n.slideTo(a, e ? 0 : void 0))
            }
            let a = 1;
                        ...
                        if (s.freeMode.momentum) {
                            if (l.velocities.length > 1) {
                                const e = l.velocities.pop(),
                                    ...
                                    i = e.time - n.time;
                                t.velocity = r / i, t.velocity /= 2, Math.abs(t.velocity) < s.freeMode.minimumVelocity && (t.velocity = 0), (i > 150 || d() - e.time > 300) && (t.velocity = 0)
                            } else t.velocity = 0;
                            ...
                            let m;
                            if (u < t.maxTranslate()) s.freeMode.momentumBounce ? (u + t.maxTranslate() < -f && (u = t.maxTranslate() - f), p = t.maxTranslate(), h = !0, l.allowMomentumBounce = !0) : u = t.maxTranslate(), s.loop && s.centeredSlides && (m = !0);
                            else if (u > t.minTranslate()) s.freeMode.momentumBounce ? (u - t.minTranslate() > f && (u = t.minTranslate() + f), p = t.minTranslate(), h = !0, l.allowMomentumBounce = !0) : u = t.minTranslate(), s.loop && s.centeredSlides && (m = !0);
                                ...
                                u = Math.abs(o[e] - u) < Math.abs(o[e - 1] - u) || "next" === t.swipeDirection ? o[e] : o[e - 1], u = -u
                            }
                            if (m && r("transitionEnd", () => {
                                    t.loopFix()
                                }), 0 !== t.velocity) {
                                if (e = a ? Math.abs((-u - t.translate) / t.velocity) : Math.abs((u - t.translate) / t.velocity), s.freeMode.sticky) {
                            ...
                            s.freeMode.momentumBounce && h ? (t.updateProgress(p), t.setTransition(e), t.setTranslate(u), t.transitionStart(!0, t.swipeDirection), t.animating = !0, i.transitionEnd(() => {
                                t && !t.destroyed && l.allowMomentumBounce && (n("momentumBounce"), t.setTransition(s.speed), setTimeout(() => {
                                    t.setTranslate(p), i.transitionEnd(() => {
                                        t && !t.destroyed && t.transitionEnd()
                                    })
                                }, 0))
                            })) : t.velocity ? (n("_freeModeNoMomentumRelease"), t.updateProgress(u), t.setTransition(e), t.setTranslate(u), t.transitionStart(!0, t.swipeDirection), t.animating || (t.animating = !0, i.transitionEnd(() => {
                                t && !t.destroyed && t.transitionEnd()
        ...
        e({
            ...
            initSlides: e => {
                ...
                r = n / a, s = Math.floor(e / a), n = Math.floor(e / a) === e / a ? e : Math.ceil(e / a) * a, "auto" !== i && "row" === o && (n = Math.max(n, i * a))
            },
            updateSlide: (e, i, a, o) => {
                const {
                    slidesPerGroup: l,
                ...
                if ("row" === p && l > 1) {
                    ...
                    f = Math.floor(r / s), h = r - f * s + t * l, d = h + f * n / u, i.css({
                        "-webkit-order": d,
                        order: d
                    })
                } else "column" === p ? (h = Math.floor(e / u), f = e - h * u, (h > s || h === s && f === u - 1) && (f += 1, f >= u && (f = 0, h += 1))) : (f = Math.floor(e / r), h = e - f * r);
            ...
            updateWrapperSize: (e, r, s) => {
                ...
                if (t.virtualSize = (e + i) * n, t.virtualSize = Math.ceil(t.virtualSize / l) - i, t.$wrapperEl.css({
                    ...
                    for (let n = 0; n < r.length; n += 1) {
                        let s = r[n];
                        o && (s = Math.floor(s)), r[n] < t.virtualSize + r[0] && e.push(s)
                    }
                    r.push(...e)
                }
            }
        ...
        e({
            ...
            setTransition: e => {
                ...
                (n ? t.slides.find(n) : t.slides).transition(e), X({
                    swiper: t,
                    duration: e,
                    transformEl: n,
                    allSlides: !0
        ...
        e({
            ...
            setTranslate: () => {
                const {
                    ...
                    size: o,
                    browser: l
                } = t, u = t.params.cubeEffect, p = t.isHorizontal(), d = t.virtual && t.params.virtual.enabled;
                let h, f = 0;
                ...
                for (let t = 0; t < r.length; t += 1) {
                    ...
                    let h = 0,
                        m = 0,
                        g = 0;
                    n % 4 == 0 ? (h = 4 * -i * o, g = 0) : (n - 1) % 4 == 0 ? (h = 0, g = 4 * -i * o) : (n - 2) % 4 == 0 ? (h = o + 4 * i * o, g = o) : (n - 3) % 4 == 0 && (h = -o, g = 3 * o + 4 * o * i), a && (h = -h), p || (m = h, h = 0);
                    const v = `rotateX(${p?0:-s}deg) rotateY(${p?s:0}deg) translate3d(${h}px, ${m}px, ${g}px)`;
                    if (l <= 1 && l > -1 && (f = 90 * n + 90 * l, a && (f = 90 * -n - 90 * l)), e.transform(v), u.slideShadows) {
                        ...
                        0 === t.length && (t = c(`<div class="swiper-slide-shadow-${p?"left":"top"}"></div>`), e.append(t)), 0 === n.length && (n = c(`<div class="swiper-slide-shadow-${p?"right":"bottom"}"></div>`), e.append(n)), t.length && (t[0].style.opacity = Math.max(-l, 0)), n.length && (n[0].style.opacity = Math.max(l, 0))
                    }
                }
                if (n.css({
                    ...
                    if (p) h.transform(`translate3d(0px, ${s/2+u.shadowOffset}px, ${-s/2}px) rotateX(90deg) rotateZ(0deg) scale(${u.shadowScale})`);
                    else {
        ...
        e({
            ...
            setTranslate: () => {
                ...
                for (let s = 0; s < e.length; s += 1) {
                    ...
                    let l = -180 * a,
                        ...
                        p = 0;
                    if (t.isHorizontal() ? n && (l = -l) : (p = u, u = 0, c = -l, l = 0), i[0].style.zIndex = -Math.abs(Math.round(a)) + e.length, r.slideShadows) {
                        ...
                        0 === e.length && (e = K(r, i, t.isHorizontal() ? "left" : "top")), 0 === n.length && (n = K(r, i, t.isHorizontal() ? "right" : "bottom")), e.length && (e[0].style.opacity = Math.max(-a, 0)), n.length && (n[0].style.opacity = Math.max(a, 0))
                    }
            ...
            setTransition: e => {
                ...
                (n ? t.slides.find(n) : t.slides).transition(e).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(e), X({
                    swiper: t,
                    duration: e,
                    transformEl: n
                })
        ...
        e({
            ...
            setTranslate: () => {
                const {
                    ...
                    slides: r,
                    slidesSizesGrid: s
                } = t, i = t.params.coverflowEffect, a = t.isHorizontal(), o = t.translate, l = a ? e / 2 - o : n / 2 - o, c = a ? i.rotate : -i.rotate, u = i.depth;
                for (let t = 0, e = r.length; t < e; t += 1) {
                    ...
                    Math.abs(g) < .001 && (g = 0), Math.abs(m) < .001 && (m = 0), Math.abs(h) < .001 && (h = 0), Math.abs(p) < .001 && (p = 0), Math.abs(d) < .001 && (d = 0), Math.abs(v) < .001 && (v = 0);
                    const y = `translate3d(${g}px,${m}px,${h}px)  rotateX(${d}deg) rotateY(${p}deg) scale(${v})`;
                    if (Y(i, e).transform(y), e[0].style.zIndex = 1 - Math.abs(Math.round(o)), i.slideShadows) {
                        ...
                        0 === t.length && (t = K(i, e, a ? "left" : "top")), 0 === n.length && (n = K(i, e, a ? "right" : "bottom")), t.length && (t[0].style.opacity = o > 0 ? o : 0), n.length && (n[0].style.opacity = -o > 0 ? -o : 0)
                    }
                }
            },
            setTransition: e => {
        ...
        G({
            ...
            setTranslate: () => {
                ...
                for (let n = 0; n < e.length; n += 1) {
                    const s = e.eq(n),
                        l = s[0].progress,
                        c = Math.min(Math.max(s[0].progress, -i.limitProgress), i.limitProgress);
                    let u = c;
                    o || (u = Math.min(Math.max(s[0].originalProgress, -i.limitProgress), i.limitProgress));
                    const p = s[0].swiperSlideOffset,
                        d = [t.params.cssMode ? -p - t.translate : -p, 0, 0],
                        h = [0, 0, 0];
                    let f = !1;
                    ...
                    c < 0 ? (m = i.next, f = !0) : c > 0 && (m = i.prev, f = !0), d.forEach((t, e) => {
                        d[e] = `calc(${t}px + (${r(m.translate[e])} * ${Math.abs(c*a)}))`
                    }), h.forEach((t, e) => {
                        h[e] = m.rotate[e] * Math.abs(c * a)
                    ...
                    if (f && m.shadow || !f) {
                        ...
                        if (0 === t.length && m.shadow && (t = K(i, s)), t.length) {
            ...
            setTransition: e => {
                ...
                (n ? t.slides.find(n) : t.slides).transition(e).find(".swiper-slide-shadow").transition(e), X({
                    swiper: t,
                    duration: e,
                    transformEl: n,
                    allSlides: !0
            ...
            setTranslate: () => {
                ...
                for (let o = 0; o < e.length; o += 1) {
                    ...
                    if (y || b) {
                        ...
                        g += -28 * u * t, m += -.5 * t, v += 96 * t, h = -25 * t * Math.abs(u) + "%"
                    }
                    if (d = u < 0 ? `calc(${d}px + (${v*Math.abs(u)}%))` : u > 0 ? `calc(${d}px + (-${v*Math.abs(u)}%))` : d + "px", !t.isHorizontal()) {
                        const t = h;
                        h = d, d = t
                    }
                    ...
                    if (r.slideShadows) {
                        ...
                        0 === t.length && (t = K(r, l)), t.length && (t[0].style.opacity = Math.min(Math.max((Math.abs(u) - .5) / .5, 0), 1))
                    }
                    l[0].style.zIndex = -Math.abs(Math.round(c)) + e.length, Y(r, l).transform(_)
                }
            },
            setTransition: e => {
                const {
...
function(t, e) {
    ...
    return d = {
        ...
        return Object.prototype.hasOwnProperty.call(t, e)
    }, f.p = "", f(f.s = "./src/js/hs-toggle-switch.js").default;
    ...
    return function(t) {
        ...
        function S(t) {
            ...
            this.getSourceTypeFromLocalStorageByUrl = function(t) {
                ...
                !1 === s[n] && (r--, "invalid" !== t ? s[n] = t : delete s[n], 0 === r && (function(t, e) {
        ...
        function C(t, e, n, r) {
            ...
            this.adjustSize = function() {
                if ((o = s.maxSourceWidth / a) < s.maxSourceHeight) return n < s.maxSourceWidth && (o = r), l();
        ...
        function x(t, e) {
            ...
            this.runActions = function(t, r) {
                o[e].classList.add(b), i[e].classList.add(g), a[e].removeChild(a[e].firstChild), c(t, r), n.runActions = c
            }
        }
        ...
        function E(t, e) {
            ...
            this.handleImageLoad = function(t) {
                ...
                var t = 1920,
                    e = 1080;
                i.maxYoutubeDimensions && (t = i.maxYoutubeDimensions.width, e = i.maxYoutubeDimensions.height), a.runActions(t, e)
        ...
        function P(t, e) {
            var n = t.collections.sourceLoadHandlers,
                ...
                a = t.props.sources;
            s[e] = document.createElement("img"), k(t, e, _), s[e].src = a[e], s[e].onload = n[e].handleImageLoad, T(t, e), i[e].appendChild(s[e])
        }
        ...
        function O(t, e) {
            var n = t.collections.sourceLoadHandlers,
                ...
                o = a.sources,
                l = a.videosPosters;
            s[e] = document.createElement("video"), k(t, e, _), s[e].src = o[e], s[e].onloadedmetadata = function(t) {
                n[e].handleVideoLoad(t)
            }, s[e].controls = !0, T(t, e), l[e] && (s[e].poster = l[e]);
            var c = document.createElement("source");
            c.src = o[e], s[e].appendChild(c), setTimeout(n[e].handleNotMetaDatedVideoLoad, 3e3), i[e].appendChild(s[e])
        }
        ...
        function M(t, e) {
            var n = t.collections.sourceLoadHandlers,
                ...
                o = t.props.sources;
            i[e] = document.createElement("iframe"), k(t, e, "".concat(_, " ").concat(s, "youtube-iframe")), i[e].src = "https://www.youtube.com/embed/".concat(o[e].match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/)[2], "?enablejsapi=1"), i[e].allowFullscreen = !0, T(t, e), a[e].appendChild(i[e]), n[e].handleYoutubeLoad()
        }
        ...
        function A(t, e) {
            var n = t.collections.sourceLoadHandlers,
                ...
                i = r.sourceAnimationWrappers,
                a = t.props.sources;
            s[e] = a[e], k(t, e, "".concat(s[e].className, " ").concat(_)), i[e].appendChild(s[e]), n[e].handleCustomLoad()
        }
        ...
        function j(t, e) {
            ...
            t.props.sources, r[e] = document.createElement("div"), r[e].className = "".concat(s, "invalid-file-wrapper ").concat(l), r[e].innerHTML = "Invalid source", i[e].classList.add(g), i[e].appendChild(r[e]), a[e].removeChild(a[e].firstChild)
        }
        ...
        function D() {
            ...
            this.setUrlToCheck = function(e) {
                ...
                e = s, (n = new XMLHttpRequest).onreadystatechange = i, n.open("GET", t, !0), n.send()
            }
        }
        ...
        function V(t, e) {
            ...
            i[e] = document.createElement("div"), i[e].className = "".concat(p, " ").concat(o, " ").concat(l), i[e].innerHTML = '<div class="fslightbox-loader"><div></div><div></div><div></div><div></div></div>';
        ...
        function $(t, e, n, r) {
            ...
            i.setAttributeNS(null, "width", e), i.setAttributeNS(null, "height", e), i.setAttributeNS(null, "viewBox", n);
            var a = document.createElementNS("http://www.w3.org/2000/svg", "path");
            return a.setAttributeNS(null, "class", "".concat(s, "svg-path")), a.setAttributeNS(null, "d", r), i.appendChild(a), t.appendChild(i), i
        }

        function N(t, e) {
            var n = document.createElement("div");
            return n.className = "".concat(s, "toolbar-button ").concat(l), n.title = e, t.appendChild(n), n
        }
        ...
        function H(t) {
            ...
            r.className = "".concat(s, "nav"), n.appendChild(r),
                function(t, e) {
                    var n = document.createElement("div");
                    n.className = "".concat(s, "toolbar"), e.appendChild(n),
                        function(t, e) {
                            ...
                            n.enterFullscreen = function() {
                                s.isFullscreenOpen = !0, a.title = "Exit fullscreen", o.setAttributeNS(null, "width", "24px"), o.setAttributeNS(null, "height", "24px"), o.setAttributeNS(null, "viewBox", "0 0 950 1024"), o.firstChild.setAttributeNS(null, "d", "M682 342h128v84h-212v-212h84v128zM598 810v-212h212v84h-128v128h-84zM342 342v-128h84v212h-212v-84h128zM214 682v-84h212v212h-84v-128h-128z")
                            }, n.exitFullscreen = function() {
                                s.isFullscreenOpen = !1, a.title = "Enter fullscreen", o.setAttributeNS(null, "width", "20px"), o.setAttributeNS(null, "height", "20px"), o.setAttributeNS(null, "viewBox", "0 0 18 18"), o.firstChild.setAttributeNS(null, "d", i)
                            }, a.onclick = function() {
                        ...
                        function(t, e) {
                            var n = N(e, "Close");
                            n.onclick = t.core.lightboxCloser.closeLightbox, $(n, "20px", "0 0 24 24", "M 4.7070312 3.2929688 L 3.2929688 4.7070312 L 10.585938 12 L 3.2929688 19.292969 L 4.7070312 20.707031 L 12 13.414062 L 19.292969 20.707031 L 20.707031 19.292969 L 13.414062 12 L 20.707031 4.7070312 L 19.292969 3.2929688 L 12 10.585938 L 4.7070312 3.2929688 z")
                        }(t, n)
                }(t, r), e.length > 1 && function(t, e) {
                    var n = t.componentsServices,
                        r = t.props.sources,
                    ...
                    u.innerHTML = r.length, i.appendChild(a), a.appendChild(o), a.appendChild(c), a.appendChild(u), e.appendChild(i), setTimeout((function() {
        ...
        function R(t, e) {
            ...
            var a = function(t) {
                    r[e].style.transform = "translateX(".concat(t + i, "px)"), i = 0
                },
                o = function() {
        ...
        function z(t, e, n, r) {
            ...
            a.className = "".concat(h, " ").concat(h, "-").concat(n), a.title = "".concat(i, " slide"), a.onclick = e,
                function(t, e) {
                    var n = document.createElement("div");
                    n.className = "".concat(d, " ").concat(l), $(n, "20px", "0 0 20 20", e), t.appendChild(n)
                }(a, r), s.appendChild(a)
        }
        ...
        function B(t) {
            ...
            this.isLightboxFadingOut = !1, this.runActions = function() {
                e.isLightboxFadingOut = !0, l.container.classList.add(v), i.removeListeners(), u.exitFullscreenOnClose && o.isFullscreenOpen && s.exitFullscreen(), setTimeout((function() {
                    e.isLightboxFadingOut = !1, p.isPointering = !1, l.container.classList.remove(v), document.documentElement.classList.remove(c), a.removeRecompense(), document.body.removeChild(l.container), r.dispatch("onClose")
                }), 270)
            }
        }
        ...
        function W(t) {
            ...
            this.runActionsForEvent = function(t) {
                var e, o, l;
                n.container.contains(n.slideSwipingHoverer) || n.container.appendChild(n.slideSwipingHoverer), e = n.container, o = a, (l = e.classList).contains(o) || l.add(o), r.swipedX = t.screenX - r.downScreenX, i(s.current, "zero"), void 0 !== s.previous && r.swipedX > 0 ? i(s.previous, "negative") : void 0 !== s.next && r.swipedX < 0 && i(s.next, "positive")
            }
        }
        ...
        function G(t) {
            ...
            this.runPositiveSwipedXActions = function() {
                void 0 === s.previous || (i("positive"), n.changeTo(s.previous)), i("zero")
            }, this.runNegativeSwipedXActions = function() {
                void 0 === s.next || (i("negative"), n.changeTo(s.next)), i("zero")
            };
            var i = function(t) {
                r[s.current].classList.add(u), e[s.current][t]()
            }
        }
        ...
        function X(t) {
            ...
            this.runNoSwipeActions = function() {
                Y(n.container, n.slideSwipingHoverer), s.isSourceDownEventTarget || e.closeLightbox(), s.isPointering = !1
            }, this.runActions = function() {
                s.swipedX > 0 ? i.runPositiveSwipedXActions() : i.runNegativeSwipedXActions(), Y(n.container, n.slideSwipingHoverer), n.container.classList.remove(a), s.isPointering = !1
            }
        }
            ...
            n = (e = t).core.classFacade, r = e.elements, n.removeFromEachElementClassIfContains = function(t, e) {
                ...
                function(t) {
                    ...
                    n.enterFullscreen = function() {
                        ...
                        e.exitFullscreen(), document.exitFullscreen ? document.exitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen ? document.webkitExitFullscreen() : document.msExitFullscreen && document.msExitFullscreen()
                    }
                }(t),
                function(t) {
                    var e = t.core,
                    ...
                    n.attachListeners = function() {
                        document.addEventListener("pointermove", a.listener), document.addEventListener("pointerup", o.listener), addEventListener("resize", r.runActions), document.addEventListener("keydown", i.listener)
                    }, n.removeListeners = function() {
                        document.removeEventListener("pointermove", a.listener), document.removeEventListener("pointerup", o.listener), removeEventListener("resize", r.runActions), document.removeEventListener("keydown", i.listener)
                    }
                }(t),
                function(t) {
                    var e = t.core.lightboxCloser,
                ...
                function(t) {
                    var e, n, r = t.collections.sourceMainWrappersTransformers,
                    ...
                    o.changeTo = function(t) {
                        d.current = t, c.updateStageIndexes(), s.setSlideNumber(t + 1), l.displaySourcesWhichShouldBeDisplayed()
                    }, o.jumpTo = function(t) {
                        var e = d.current;
                        o.changeTo(t), a.removeFromEachElementClassIfContains("sourceMainWrappers", u), q(p[e], g), q(p[e], f), p[e].classList.add(m), q(p[t], g), q(p[t], m), p[t].classList.add(f), h(), r[t].zero(), setTimeout((function() {
                ...
                function(t) {
                    ...
                    r.listener = function(t) {
                        "VIDEO" !== t.target.tagName && t.preventDefault(), i.isPointering = !0, i.downScreenX = t.screenX, i.swipedX = 0;
                        var e = s[a.current];
                        e && e.contains(t.target) ? i.isSourceDownEventTarget = !0 : i.isSourceDownEventTarget = !1, n.removeFromEachElementClassIfContains("sourceMainWrappers", u)
                    }
                }(t),
                function(t) {
                ...
                function(t) {
                    ...
                    s.runActions = function() {
                        ...
                        for (var t = 0; t < o.sources.length; t++) q(a[t], u), t !== l.current && n[t].negative(), r[t] && r[t].adjustSize()
                    }
                }(t)
        }
        ...
        function J(t) {
            var e = t.core.eventsDispatcher,
                ...
                r = t.elements,
                i = t.props.sources;
            n.isInitialized = !0, n.scrollbarWidth = function(t) {
                    ...
                    var o = i - a;
                    return e || localStorage.setItem("fslightbox-scrollbar-width", o.toString()), o
                }(t),
                function(t) {
                    for (var e = t.collections.sourceMainWrappersTransformers, n = t.props.sources, r = t.resolve, s = 0; s < n.length; s++) e[s] = r(R, [s])
                }(t), Q(t), r.container = document.createElement("div"), r.container.className = "".concat(s, "container ").concat(o, " ").concat(g),
                function(t) {
                    var e = t.elements;
                    e.slideSwipingHoverer = document.createElement("div"), e.slideSwipingHoverer.className = "".concat(s, "slide-swiping-hoverer ").concat(o, " ").concat(p)
                }(t), H(t),
                function(t) {
                    ...
                    s.className = "".concat(p, " ").concat(o), n.container.appendChild(s), s.addEventListener("pointerdown", e.listener), n.sourceWrappersContainer = s;
                    for (var i = 0; i < r.length; i++) V(t, i)
                }(t), i.length > 1 && function(t) {
        ...
        function Z(t) {
            ...
            i.open = function() {
                ...
                f.current = r, d.isInitialized ? s.dispatch("onShow") : J(t), u.updateStageIndexes(), l.displaySourcesWhichShouldBeDisplayed(), n.setSlideNumber(r + 1), document.body.appendChild(h.container), document.documentElement.classList.add(c), o.addRecompense(), a.attachListeners(), p.runActions(), e[f.current].zero(), s.dispatch("onOpen")
            }
        }
        ...
        function it() {
            for (var t = document.getElementsByTagName("a"), e = function(e) {
                    ...
                    var s = null;
                    "#" === r.charAt(0) ? (s = document.getElementById(r.substring(1)).cloneNode(!0)).removeAttribute("id") : s = r, fsLightboxInstances[n].props.sources.push(s), fsLightboxInstances[n].elements.a.push(t[e]);
...
var countdown = function(t) {
        ...
        function r(t, e) {
            var n = t.getTime();
            return t.setMonth(t.getMonth() + e), Math.round((t.getTime() - n) / 864e5)
        }

        function s(t) {
            var e = t.getTime(),
                n = new Date(e);
            return n.setMonth(t.getMonth() + 1), Math.round((n.getTime() - e) / 864e5)
        }
        ...
        function g(t, e, n, r, i, a) {
            return t[n] >= 0 && (e += t[n], delete t[n]), (e /= i) + 1 <= 1 ? 0 : t[r] >= 0 ? (t[r] = +(t[r] + e).toFixed(a), function(t, e) {
                switch (e) {
                    case "seconds":
                        if (60 !== t.seconds || isNaN(t.minutes)) return;
                        t.minutes++, t.seconds = 0;
                    case "minutes":
                        if (60 !== t.minutes || isNaN(t.hours)) return;
                        t.hours++, t.minutes = 0;
                    case "hours":
                        if (24 !== t.hours || isNaN(t.days)) return;
                        t.days++, t.hours = 0;
                    case "days":
                        if (7 !== t.days || isNaN(t.weeks)) return;
                        t.weeks++, t.days = 0;
                    case "weeks":
                        if (t.weeks !== s(t.refMonth) / 7 || isNaN(t.months)) return;
                        t.months++, t.weeks = 0;
                    case "months":
                        if (12 !== t.months || isNaN(t.years)) return;
                        t.years++, t.months = 0;
                    case "years":
                        if (10 !== t.years || isNaN(t.decades)) return;
                        t.decades++, t.years = 0;
                    case "decades":
                        if (10 !== t.decades || isNaN(t.centuries)) return;
                        t.centuries++, t.decades = 0;
                    case "centuries":
                        if (10 !== t.centuries || isNaN(t.millennia)) return;
        ...
        function v(t, e) {
            ...
            if (a && ((a = g(t, a, "seconds", "minutes", 60, e)) && (a = g(t, a, "minutes", "hours", 60, e)) && (a = g(t, a, "hours", "days", 24, e)) && (a = g(t, a, "days", "weeks", 7, e)) && (a = g(t, a, "weeks", "months", s(t.refMonth) / 7, e)) && (a = g(t, a, "months", "years", (n = t.refMonth, r = n.getTime(), (i = new Date(r)).setFullYear(n.getFullYear() + 1), Math.round((i.getTime() - r) / 864e5) / s(t.refMonth)), e)) && (a = g(t, a, "years", "decades", 10, e)) && (a = g(t, a, "decades", "centuries", 10, e)) && (a = g(t, a, "centuries", "millennia", 10, e)))) throw new Error("Fractional unit overflow")
        }

        function y(t, s, i, a, o, l) {
            var c = new Date;
            if (t.start = s = s || c, t.end = i = i || c, t.units = a, t.value = i.getTime() - s.getTime(), t.value < 0) {
                var u = i;
                i = s, s = u
            }
            t.refMonth = new Date(s.getFullYear(), s.getMonth(), 15, 12, 0, 0);
            try {
                t.millennia = 0, t.centuries = 0, t.decades = 0, t.years = i.getFullYear() - s.getFullYear(), t.months = i.getMonth() - s.getMonth(), t.weeks = 0, t.days = i.getDate() - s.getDate(), t.hours = i.getHours() - s.getHours(), t.minutes = i.getMinutes() - s.getMinutes(), t.seconds = i.getSeconds() - s.getSeconds(), t.milliseconds = i.getMilliseconds() - s.getMilliseconds(),
                    function(t) {
                        var s;
                        for (t.milliseconds < 0 ? (s = e(-t.milliseconds / 1e3), t.seconds -= s, t.milliseconds += 1e3 * s) : t.milliseconds >= 1e3 && (t.seconds += n(t.milliseconds / 1e3), t.milliseconds %= 1e3), t.seconds < 0 ? (s = e(-t.seconds / 60), t.minutes -= s, t.seconds += 60 * s) : t.seconds >= 60 && (t.minutes += n(t.seconds / 60), t.seconds %= 60), t.minutes < 0 ? (s = e(-t.minutes / 60), t.hours -= s, t.minutes += 60 * s) : t.minutes >= 60 && (t.hours += n(t.minutes / 60), t.minutes %= 60), t.hours < 0 ? (s = e(-t.hours / 24), t.days -= s, t.hours += 24 * s) : t.hours >= 24 && (t.days += n(t.hours / 24), t.hours %= 24); t.days < 0;) t.months--, t.days += r(t.refMonth, 1);
                        t.days >= 7 && (t.weeks += n(t.days / 7), t.days %= 7), t.months < 0 ? (s = e(-t.months / 12), t.years -= s, t.months += 12 * s) : t.months >= 12 && (t.years += n(t.months / 12), t.months %= 12), t.years >= 10 && (t.decades += n(t.years / 10), t.years %= 10, t.decades >= 10 && (t.centuries += n(t.decades / 10), t.decades %= 10, t.centuries >= 10 && (t.millennia += n(t.centuries / 10), t.centuries %= 10)))
                    }(t),
                    function(t, e, s, i) {
                        var a = 0;
                        !(1024 & e) || a >= s ? (t.centuries += 10 * t.millennia, delete t.millennia) : t.millennia && a++, !(512 & e) || a >= s ? (t.decades += 10 * t.centuries, delete t.centuries) : t.centuries && a++, !(256 & e) || a >= s ? (t.years += 10 * t.decades, delete t.decades) : t.decades && a++, !(128 & e) || a >= s ? (t.months += 12 * t.years, delete t.years) : t.years && a++, !(64 & e) || a >= s ? (t.months && (t.days += r(t.refMonth, t.months)), delete t.months, t.days >= 7 && (t.weeks += n(t.days / 7), t.days %= 7)) : t.months && a++, !(32 & e) || a >= s ? (t.days += 7 * t.weeks, delete t.weeks) : t.weeks && a++, !(16 & e) || a >= s ? (t.hours += 24 * t.days, delete t.days) : t.days && a++, !(8 & e) || a >= s ? (t.minutes += 60 * t.hours, delete t.hours) : t.hours && a++, !(4 & e) || a >= s ? (t.seconds += 60 * t.minutes, delete t.minutes) : t.minutes && a++, !(2 & e) || a >= s ? (t.milliseconds += 1e3 * t.seconds, delete t.seconds) : t.seconds && a++, 1 & e && !(a >= s) || v(t, i)
                    }(t, a, o, l)
            } finally {
                delete t.refMonth
            }
        ...
        function b(t, e, n, r, s) {
            var a;
            n = +n || 222, r = r > 0 ? r : NaN, s = s > 0 ? s < 20 ? Math.round(s) : 20 : 0;
            var o = null;
            "function" == typeof t ? (a = t, t = null) : t instanceof Date || (null !== t && isFinite(t) ? t = new Date(+t) : ("object" == typeof o && (o = t), t = null));
            var l = null;
            if ("function" == typeof e ? (a = e, e = null) : e instanceof Date || (null !== e && isFinite(e) ? e = new Date(+e) : ("object" == typeof e && (l = e), e = null)), o && (t = i(o, e)), l && (e = i(l, t)), !t && !e) return new m;
            if (!a) return y(new m, t, e, n, r, s);
            var c, u = function(t) {
        ...
        m.prototype.toString = function(t) {
            ...
            var n = h(this),
                r = n.length;
            if (!r) return (e = e || u) ? "<" + t + ">" + e + "</" + t + ">" : e;
            for (var s = 0; s < r; s++) n[s] = "<" + t + ">" + n[s] + "</" + t + ">";
            if (1 === r) return n[0];
            var i = l + n.pop();
            return n.join(c) + i
            ...
            var e = [],
                n = t.millennia;
            return n && e.push(p(n, 10)), (n = t.centuries) && e.push(p(n, 9)), (n = t.decades) && e.push(p(n, 8)), (n = t.years) && e.push(p(n, 7)), (n = t.months) && e.push(p(n, 6)), (n = t.weeks) && e.push(p(n, 5)), (n = t.days) && e.push(p(n, 4)), (n = t.hours) && e.push(p(n, 3)), (n = t.minutes) && e.push(p(n, 2)), (n = t.seconds) && e.push(p(n, 1)), (n = t.milliseconds) && e.push(p(n, 0)), e
        }, b.MILLISECONDS = 1, b.SECONDS = 2, b.MINUTES = 4, b.HOURS = 8, b.DAYS = 16, b.WEEKS = 32, b.MONTHS = 64, b.YEARS = 128, b.DECADES = 256, b.CENTURIES = 512, b.MILLENNIA = 1024, b.DEFAULTS = 222, b.ALL = 2047;
        var _ = b.setFormat = function(t) {
                if (t) {
                    if ("singular" in t || "plural" in t) {
                        ...
                        var n = t.plural || [];
                        n.split && (n = n.split("|"));
                        for (var r = 0; r <= 10; r++) a[r] = e[r] || a[r], o[r] = n[r] || o[r]
                    }
                    "string" == typeof t.last && (l = t.last), "string" == typeof t.delim && (c = t.delim), "string" == typeof t.empty && (u = t.empty), "function" == typeof t.formatNumber && (d = t.formatNumber), "function" == typeof t.formatter && (p = t.formatter)
                }
            },
            w = b.resetFormat = function() {
                a = " millisecond| second| minute| hour| day| week| month| year| decade| century| millennium".split("|"), o = " milliseconds| seconds| minutes| hours| days| weeks| months| years| decades| centuries| millennia".split("|"), l = " and ", c = ", ", u = "", d = function(t) {
                    return t
                }, p = f
            };
        ...
        }, b.resetLabels = w, w(), t && t.exports ? t.exports = b : "function" == typeof window.define && void 0 !== window.define.amd && window.define("countdown", [], (function() {
            return b
        })), b
    }(module),
    List;
...
function(t, e) {
    ...
    return function(t) {
        ...
        return n.m = t, n.c = e, n.d = function(t, e, r) {
            ...
            return Object.prototype.hasOwnProperty.call(t, e)
        }, n.p = "", n(n.s = "./src/js/hs-toggle-password.js")
    }({
...
function(t, e) {
    ...
    return d = {
        ...
        return Object.prototype.hasOwnProperty.call(t, e)
    }, f.p = "", f(f.s = "./src/js/hs-scrollspy.js").default;
...
function(t, e) {
    ...
    l.prototype = {
        ...
        once: function(t, e, n) {
            ...
            function s() {
                r.off(t, s), e.apply(n, arguments)
            }
            return s._ = e, this.on(t, s, n)
        },
        emit: function(t) {
            for (var e = [].slice.call(arguments, 1), n = ((this.e || (this.e = {}))[t] || []).slice(), r = 0, s = n.length; r < s; r++) n[r].fn.apply(n[r].ctx, e);
            return this
        },
        off: function(t, e) {
            var n = this.e || (this.e = {}),
                ...
                s = [];
            if (r && e)
                for (var i = 0, a = r.length; i < a; i++) r[i].fn !== e && r[i].fn._ !== e && s.push(r[i]);
    ...
    var h = function(t, e) {
        ...
        return function() {
            n = this, r = arguments;
            var t = new Date - a;
            return i || (t >= e ? o() : i = setTimeout(o, e - t)), s
        };

        function o() {
            i = 0, a = +new Date, s = t.apply(n, r), n = null, r = null
        }
    };
    ...
    var g = function() {
            function e(n, r) {
                t(this, e), this.x = m(n), this.y = m(r)
            }
            return n(e, null, [{
                key: "equals",
                value: function(t, e) {
        ...
        v = function() {
            function e(n, r, s, i, a) {
                t(this, e), this.id = a, this.left = n, this.top = r, this.width = s, this.height = i
            }
            return n(e, null, [{
                key: "intersects",
                value: function(t, e) {
        ...
        _ = function() {
            function e(n, r) {
                t(this, e), b += 1, this.id = b, this.element = n, this.isRTL = r, this.isVisible = !0, this.isHidden = !1
            }
            return n(e, [{
                key: "show",
                value: function() {
                ...
                key: "init",
                value: function() {
                    this.addClasses([y.SHUFFLE_ITEM, y.VISIBLE]), this.applyCss(e.Css.INITIAL), this.applyCss(this.isRTL ? e.Css.DIRECTION.rtl : e.Css.DIRECTION.ltr), this.scale = e.Scale.VISIBLE, this.point = new g
                }
            }, {
                key: "addClasses",
                value: function(t) {
    ...
    var w = null,
        S = function() {
            ...
            return w = 10 === Math.round(m(n)), t.removeChild(e), w
        };

    function C(t, e) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : window.getComputedStyle(t, null),
            r = m(n[e]);
        return S() || "width" !== e ? S() || "height" !== e || (r += m(n.paddingTop) + m(n.paddingBottom) + m(n.borderTopWidth) + m(n.borderBottomWidth)) : r += m(n.paddingLeft) + m(n.paddingRight) + m(n.borderLeftWidth) + m(n.borderRightWidth), r
    }
    var x = {
        reverse: !1,
        by: null,
    ...
    function E(t, e) {
        ...
        return t.length ? n.randomize ? function(t) {
            ...
            var r = n.by(t[n.key]),
                i = n.by(e[n.key]);
            return void 0 === r && void 0 === i ? (s = !0, 0) : r < i || "sortFirst" === r || "sortLast" === i ? -1 : r > i || "sortLast" === r || "sortFirst" === i ? 1 : 0
        })) : "function" == typeof n.compare && t.sort(n.compare), s ? r : (n.reverse && t.reverse(), t)) : []
    }
    var k = {},
        T = 0;
    ...
    function O(t, e) {
        var n = "transitionend" + (T += 1),
            r = function(t) {
                t.currentTarget === t.target && (P(n), e(t))
            };
        return t.addEventListener("transitionend", r), k[n] = {
            element: t,
            listener: r
        }, n
    }
    ...
    function A(t, e, n, r) {
        var s = t / e;
        return Math.abs(Math.round(s) - s) < r && (s = Math.round(s)), Math.min(Math.ceil(s), n)
    }

    function j(t, e, n) {
        if (1 === e) return t;
        for (var r = [], s = 0; s <= n - e; s++) r.push(M(t.slice(s, s + e)));
        return r
    }

    function I(t, e) {
        for (var n, r = (n = t, Math.min.apply(Math, n)), s = 0, i = t.length; s < i; s++)
            if (t[s] >= r - e && t[s] <= r + e) return s;
        return 0
    }
    ...
    var V = 0,
        $ = function(e) {
            ...
            function i(e) {
                ...
                t(this, i), (n = r.call(this)).options = Object.assign({}, i.options, s), n.options.delimeter && (n.options.delimiter = n.options.delimeter), n.lastSort = {}, n.group = i.ALL_ITEMS, n.lastFilter = i.ALL_ITEMS, n.isEnabled = !0, n.isDestroyed = !1, n.isInitialized = !1, n._transitions = [], n.isTransitioning = !1, n._queue = [];
                var a = n._getElementOption(e);
                if (!a) throw new TypeError("Shuffle needs to be initialized with an element.");
                return n.element = a, n.id = "shuffle_" + V, V += 1, n._init(), n.isInitialized = !0, n
            }
            return n(i, [{
                key: "_init",
                value: function() {
                    if (this.items = this._getItems(), this.sortedItems = this.items, this.options.sizer = this._getElementOption(this.options.sizer), this.element.classList.add(i.Classes.BASE), this._initItems(this.items), this._onResize = this._getResizeFunction(), window.addEventListener("resize", this._onResize), "complete" !== document.readyState) {
                ...
                value: function(t) {
                    var e = this.options,
                        ...
                        a = s.concat(i).join();
                    t.forEach((function(t) {
                        t.element.style.transitionDuration = n + "ms", t.element.style.transitionTimingFunction = r, t.element.style.transitionProperty = a
                    }))
                }
            }, {
                key: "_getItems",
                ...
                value: function(t) {
                    ...
                    t.forEach((function(t, s) {
                        ...
                        if (g.equals(t.point, n[s]) && !t.isHidden) return t.applyCss(_.Css.VISIBLE.before), void i();
                        t.point = n[s], t.scale = _.Scale.VISIBLE, t.isHidden = !1;
                        var a = e.getStylesForTransition(t, _.Css.VISIBLE.before);
                        a.transitionDelay = e._getStaggerAmount(r) + "ms", e._queue.push({
                            item: t,
                            styles: a,
                            callback: i
                        }), r += 1
                ...
                value: function(t) {
                    return function(t) {
                        for (var e = t.itemSize, n = t.positions, r = t.gridSize, s = t.total, i = t.threshold, a = t.buffer, o = A(e.width, r, s, i), l = j(n, o, s), c = I(l, a), u = new g(r * c, l[c]), p = l[c] + e.height, d = 0; d < o; d++) n[c + d] = p;
                        return u
                    }({
                        itemSize: t,
                ...
                value: function() {
                    ...
                    e.forEach((function(e) {
                        ...
                        if (e.isHidden) return e.applyCss(_.Css.HIDDEN.before), void r();
                        e.scale = _.Scale.HIDDEN, e.isHidden = !0;
                        var s = t.getStylesForTransition(e, _.Css.HIDDEN.before);
                        s.transitionDelay = t._getStaggerAmount(n) + "ms", t._queue.push({
                            item: e,
                            styles: s,
                            callback: r
                        }), n += 1
                ...
                key: "_cancelMovement",
                value: function() {
                    this._transitions.forEach(P), this._transitions.length = 0, this.isTransitioning = !1
                }
            }, {
                ...
                value: function(t) {
                    ...
                    s.visible.forEach((function(t, n) {
                        i(t) && (t.point = o[n], a(t), t.applyCss(e.getStylesForTransition(t, {})))
                ...
                value: function(t) {
                    ...
                    if (t.length) {
                        ...
                        this._toggleFilterClasses({
                            ...
                            e._disposeItems(r), n.forEach((function(t) {
    ...
    return $.ShuffleItem = _, $.ALL_ITEMS = "all", $.FILTER_ATTRIBUTE_KEY = "groups", $.EventType = {
        LAYOUT: "shuffle:layout",
        REMOVED: "shuffle:removed"
    }, $.Classes = y, $.FilterMode = {
        ANY: "any",
        ALL: "all"
    }, $.options = {
        group: $.ALL_ITEMS,
        ...
        isRTL: !1,
        roundTransforms: !0
    }, $.Point = g, $.Rect = v, $.__sorter = E, $.__getColumnSpan = A, $.__getAvailablePositions = j, $.__getShortColumn = I, $.__getCenteredPositions = D, $
})), List = function() {
    var t = {
            "./src/add-async.js": function(t) {
                t.exports = function(t) {
                    return function e(n, r, s) {
                        var i = n.splice(0, 50);
                        s = (s = s || []).concat(t.add(i)), n.length > 0 ? setTimeout((function() {
                            e(n, r, s)
                        }), 1) : (t.update(), r(s))
                    }
                }
            ...
            "./src/fuzzy-search.js": function(t, e, n) {
                ...
                t.exports = function(t, e) {
                    ...
                    var n = {
                        search: function(r, s) {
                            for (var i = e.multiSearch ? r.replace(/ +$/, "").split(/ +/) : [r], a = 0, o = t.items.length; a < o; a++) n.item(t.items[a], s, i)
                        },
                        item: function(t, e, r) {
                            for (var s = !0, i = 0; i < r.length; i++) {
                                for (var a = !1, o = 0, l = e.length; o < l; o++) n.values(t.values(), e[o], r[i]) && (a = !0);
                                a || (s = !1)
                            }
                            t.found = s
                        },
            ...
            "./src/index.js": function(t, e, n) {
                ...
                t.exports = function(t, e, d) {
                    var h, f = this,
                        m = n("./src/item.js")(f),
                        g = n("./src/add-async.js")(f),
                        v = n("./src/pagination.js")(f);
                    h = {
                        start: function() {
                            f.listClass = "list", f.searchClass = "search", f.sortClass = "sort", f.page = 1e4, f.i = 1, f.items = [], f.visibleItems = [], f.matchingItems = [], f.searched = !1, f.filtered = !1, f.searchColumns = void 0, f.searchDelay = 0, f.handlers = {
                                updated: []
                                ...
                                getAttribute: u,
                                toArray: p
                            }, f.utils.extend(f, e), f.listContainer = "string" == typeof t ? document.getElementById(t) : t, f.listContainer && (f.list = s(f.listContainer, f.listClass, !0), f.parse = n("./src/parse.js")(f), f.templater = n("./src/templater.js")(f), f.search = n("./src/search.js")(f), f.filter = n("./src/filter.js")(f), f.sort = n("./src/sort.js")(f), f.fuzzySearch = n("./src/fuzzy-search.js")(f, e.fuzzySearch), this.handlers(), this.items(), this.pagination(), f.update())
                        },
                        handlers: function() {
                            for (var t in f.handlers) f[t] && f.handlers.hasOwnProperty(t) && f.on(t, f[t])
                        },
                        items: function() {
                        ...
                        for (var t = [], e = 0, n = f.items.length; e < n; e++) t.push(f.items[e].values());
                        return t
                        ...
                        if (0 !== t.length) {
                            if (!e) {
                                ...
                                for (var s = 0, i = t.length; s < i; s++) {
                                    var a;
                                    r = f.items.length > f.page, a = new m(t[s], void 0, r), f.items.push(a), n.push(a)
                                }
                                return f.update(), n
                            }
                            g(t.slice(0), e)
                        ...
                        for (var r = 0, s = 0, i = f.items.length; s < i; s++) f.items[s].values()[t] == e && (f.templater.remove(f.items[s], n), f.items.splice(s, 1), i--, s--, r++);
                        return f.update(), r
                        ...
                        for (var n = 0; n < e; n++) t[n].matching() && f.matchingItems.length + 1 >= f.i && f.visibleItems.length < f.page ? (t[n].show(), f.visibleItems.push(t[n]), f.matchingItems.push(t[n])) : t[n].matching() ? (f.matchingItems.push(t[n]), t[n].hide()) : t[n].hide();
            ...
            "./src/item.js": function(t) {
                t.exports = function(t) {
                    return function(e, n, r) {
                        var s = this;
                        this._values = {}, this.found = !1, this.filtered = !1, this.values = function(e, n) {
                    ...
                    var e = !1,
                        n = function(n, s) {
                            ...
                            var i, o = t.matchingItems.length,
                                ...
                                p = Math.ceil(l / c),
                                d = s.innerWindow || 2,
                                h = s.left || s.outerWindow || 0,
                                f = s.right || s.outerWindow || 0;
                            f = u - f, n.clear();
                            for (var m = 1; m <= u; m++) {
                                var g = p === m ? "active" : "";
                                a.number(m, h, f, p, d) ? (i = n.add({
                                    page: m,
                                    dotted: !1
                                })[0], g && r(i.elm).add(g), i.elm.firstChild.setAttribute("data-i", m), i.elm.firstChild.setAttribute("data-page", c)) : a.dotted(n, m, h, f, p, d, n.size()) && (i = n.add({
                                    page: "...",
                                    dotted: !0
                                })[0], r(i.elm).add("disabled"))
                            }
                        },
                        a = {
            ...
            "./src/parse.js": function(t, e, n) {
                t.exports = function(t) {
                    var e = n("./src/item.js")(t),
                        r = function(n, r) {
                            for (var s = 0, i = n.length; s < i; s++) t.items.push(new e(r, n[s]))
                        };
                    return t.handlers.parseComplete = t.handlers.parseComplete || [],
                        function() {
                            var e = function(t) {
                                    for (var e = t.childNodes, n = [], r = 0, s = e.length; r < s; r++) void 0 === e[r].data && n.push(e[r]);
                                    return n
                                }(t.list),
                                n = t.valueNames;
                            t.indexAsync ? function e(n, s) {
                                var i = n.splice(0, 50);
                                r(i, s), n.length > 0 ? setTimeout((function() {
                                    e(n, s)
                ...
                t.exports = function(t) {
                    var e, n, r, s = {
                            ...
                            setOptions: function(t) {
                                2 == t.length && t[1] instanceof Array ? e = t[1] : 2 == t.length && "function" == typeof t[1] ? (e = void 0, r = t[1]) : 3 == t.length ? (e = t[1], r = t[2]) : e = void 0
                            },
                            setColumns: function() {
                        ...
                        i = function() {
                            for (var r, s = [], i = n; null !== (r = i.match(/"([^"]+)"/));) s.push(r[1]), i = i.substring(0, r.index) + i.substring(r.index + r[0].length);
                        ...
                        o = function(o) {
                            return t.trigger("searchStart"), s.resetList(), s.setSearchString(o), s.setOptions(arguments), s.setColumns(), "" === n ? a() : (t.searched = !0, r ? r(n, e) : i()), t.update(), t.trigger("searchComplete"), t.visibleItems
                        };
                ...
                t.exports = function(t) {
                    var e = {
                        ...
                        n = function() {
                            ...
                            r ? (n.valueName = t.utils.getAttribute(r, "data-sort"), e.getInSensitive(r, n), n.order = e.getOrder(r)) : ((n = arguments[1] || n).valueName = arguments[0], n.order = n.order || "asc", n.insensitive = void 0 === n.insensitive || n.insensitive), e.clear(), e.setOrder(n);
                            var s, i = n.sortFunction || t.sortFunction || null,
                                a = "desc" === n.order ? -1 : 1;
                            s = i ? function(t, e) {
                                return i(t, e, n) * a
                            } : function(e, r) {
                                var s = t.utils.naturalSort;
                                return s.alphabet = t.alphabet || n.alphabet || void 0, !s.alphabet && n.insensitive && (s = t.utils.naturalSort.caseInsensitive), s(e.values()[n.valueName], r.values()[n.valueName]) * a
                    ...
                    this.get = function(e, r) {
                            ...
                            for (var s = {}, i = 0, a = r.length; i < a; i++) {
                                var o = void 0,
                                    l = r[i];
                                if (l.data)
                                    for (var c = 0, u = l.data.length; c < u; c++) s[l.data[c]] = t.utils.getAttribute(e.elm, "data-" + l.data[c]);
                            ...
                            return void 0 === t.elm && (t.elm = e(t.values()), n.set(t, t.values()), !0)
                            ...
                            if ("function" != typeof t.item) {
                                if (!(n = "string" == typeof t.item ? -1 === t.item.indexOf("<") ? document.getElementById(t.item) : r(t.item) : function() {
                                        for (var e = t.list.childNodes, n = 0, r = e.length; n < r; n++)
                                            if (void 0 === e[n].data) return e[n].cloneNode(!0)
                                ...
                                n = function(e, n) {
                                    ...
                                    for (var s = 0, i = n.length; s < i; s++) {
                                        ...
                                        else o.attr && o.name ? (a = t.utils.getByClass(r, o.name, !0)) && a.setAttribute(o.attr, "") : (a = t.utils.getByClass(r, o, !0)) && (a.innerHTML = "")
                                    }
                                    return r
                                }(n, t.valueNames), e = function() {
            ...
            "./src/utils/classes.js": function(t, e, n) {
                ...
                Object.prototype.toString, t.exports = function(t) {
                    return new i(t)
            ...
            "./src/utils/events.js": function(t, e, n) {
                ...
                e.bind = function(t, e, n, s) {
                    for (var o = 0, l = (t = a(t)).length; o < l; o++) t[o][r](i + e, n, s || !1)
                }, e.unbind = function(t, e, n, r) {
                    for (var o = 0, l = (t = a(t)).length; o < l; o++) t[o][s](i + e, n, r || !1)
            ...
            "./src/utils/fuzzy.js": function(t) {
                t.exports = function(t, e, n) {
                    ...
                    var c = i,
                        u = t.indexOf(e, a); - 1 != u && (c = Math.min(l(0, u), c), -1 != (u = t.lastIndexOf(e, a + e.length)) && (c = Math.min(l(0, u), c)));
                    var p, d, h = 1 << e.length - 1;
                    u = -1;
                    for (var f, m = e.length + t.length, g = 0; g < e.length; g++) {
                        for (p = 0, d = m; p < d;) l(g, a + d) <= c ? p = d : m = d, d = Math.floor((m - p) / 2 + p);
                        m = d;
                        ...
                        for (var _ = y; _ >= v; _--) {
                            ...
                            if (b[_] = 0 === g ? (b[_ + 1] << 1 | 1) & w : (b[_ + 1] << 1 | 1) & w | (f[_ + 1] | f[_]) << 1 | 1 | f[_ + 1], b[_] & h) {
                                var S = l(g, _ - 1);
                                if (S <= c) {
            ...
            "./src/utils/get-attribute.js": function(t) {
                t.exports = function(t, e) {
                    ...
                    if (!n)
                        for (var r = t.attributes, s = r.length, i = 0; i < s; i++) void 0 !== r[i] && r[i].nodeName === e && (n = r[i].nodeValue);
                    return n
                }
            },
            ...
            "./src/utils/to-array.js": function(t) {
                t.exports = function(t) {
                    ...
                    for (var e = [], n = 0, r = t.length; n < r; n++)(Object.prototype.hasOwnProperty.call(t, n) || n in t) && e.push(t[n]);
                    return e.length ? e : []
                }
            },
            ...
            "./node_modules/string-natural-compare/natural-compare.js": function(t) {
                ...
                function i(t, e) {
                    for (var i = (t += "").length, a = (e += "").length, o = 0, l = 0; o < i && l < a;) {
                        ...
                        if (s(c)) {
                            if (!s(u)) return c - u;
                            for (var p = o, d = l; 48 === c && ++p < i;) c = t.charCodeAt(p);
                            for (; 48 === u && ++d < a;) u = e.charCodeAt(d);
                            for (var h = p, f = d; h < i && s(t.charCodeAt(h));) ++h;
                            for (; f < a && s(e.charCodeAt(f));) ++f;
                            var m = h - p - f + d;
                            if (m) return m;
                            for (; p < h;)
                            ...
                            if (c !== u) return c < r && u < r && -1 !== n[c] && -1 !== n[u] ? n[c] - n[u] : c - u;
                            ++o, ++l
                        }
                    }
                ...
                i.caseInsensitive = i.i = function(t, e) {
                    ...
                    alphabet: {
                        ...
                        set: function(t) {
                            ...
                            var s = 0;
                            if (e = t)
                                for (; s < e.length; s++) n[e.charCodeAt(s)] = s;
                            for (r = n.length, s = 0; s < r; s++) void 0 === n[s] && (n[s] = -1)
                        }
                    }
                }), t.exports = i
            }
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function() {
        var t = /\blang(?:uage)?-(\w+)\b/i,
            ...
            n = _self.Prism = {
                    ...
                    clone: function(t, e) {
                        ...
                        switch (e = e || {}, r) {
                            case "Object":
                                ...
                                var s = {};
                                for (var i in e[n.util.objId(t)] = s, t) t.hasOwnProperty(i) && (s[i] = n.util.clone(t[i], e));
                                return s;
                            case "Array":
                                if (e[n.util.objId(t)]) return e[n.util.objId(t)];
                                s = [];
                                return e[n.util.objId(t)] = s, t.forEach((function(t, r) {
                ...
                languages: {
                    ...
                    insertBefore: function(t, e, r, s) {
                        ...
                        if (2 == arguments.length) {
                            for (var a in r = arguments[1]) r.hasOwnProperty(a) && (i[a] = r[a]);
                            return i
                        }
                        var o = {};
                        for (var l in i)
                    ...
                    DFS: function(t, e, r, s) {
                        for (var i in s = s || {}, t) t.hasOwnProperty(i) && (e.call(t, i, t[i], r || i), "Object" !== n.util.type(t[i]) || s[n.util.objId(t[i])] ? "Array" !== n.util.type(t[i]) || s[n.util.objId(t[i])] || (s[n.util.objId(t[i])] = !0, n.languages.DFS(t[i], e, i, s)) : (s[n.util.objId(t[i])] = !0, n.languages.DFS(t[i], e, null, s)))
                    }
                },
                plugins: {},
                ...
                highlightAllUnder: function(t, e, r) {
                    ...
                    for (var i, a = s.elements || t.querySelectorAll(s.selector), o = 0; i = a[o++];) n.highlightElement(i, !0 === e, s.callback)
                },
                highlightElement: function(e, r, s) {
                    for (var i, a, o = e; o && !t.test(o.className);) o = o.parentNode;
                    o && (i = (o.className.match(t) || [, ""])[1].toLowerCase(), a = n.languages[i]), e.className = e.className.replace(t, "").replace(/\s+/g, " ") + " language-" + i, e.parentNode && (o = e.parentNode, /pre/i.test(o.nodeName) && (o.className = o.className.replace(t, "").replace(/\s+/g, " ") + " language-" + i));
                    var l = {
                        element: e,
                        language: i,
                        grammar: a,
                    ...
                    if (n.hooks.run("before-highlight", l), r && _self.Worker) {
                        ...
                        c.onmessage = function(t) {
                            l.highlightedCode = t.data, n.hooks.run("before-insert", l), l.element.innerHTML = l.highlightedCode, s && s.call(l.element), n.hooks.run("after-highlight", l), n.hooks.run("complete", l)
                        }, c.postMessage(JSON.stringify({
                            language: l.language,
                            code: l.code,
                            immediateClose: !0
                        }))
                    } else l.highlightedCode = n.highlight(l.code, l.grammar, l.language), n.hooks.run("before-insert", l), l.element.innerHTML = l.highlightedCode, s && s.call(e), n.hooks.run("after-highlight", l), n.hooks.run("complete", l)
                },
                highlight: function(t, e, s) {
                    ...
                    return n.hooks.run("before-tokenize", i), i.tokens = n.tokenize(i.code, i.grammar), n.hooks.run("after-tokenize", i), r.stringify(n.util.encode(i.tokens), i.language)
                },
                                ...
                                for (var b = s, _ = i; b < e.length; _ += e[b].length, ++b) {
                                    ...
                                    if (!(w instanceof l)) {
                                        if (m && b != e.length - 1) {
                                            ...
                                            for (var S = T.index + (f ? T[1].length : 0), C = T.index + T[0].length, x = b, E = _, k = e.length; k > x && (C > E || !e[x].type && !e[x - 1].greedy); ++x) S >= (E += e[x].length) && (++b, _ = E);
                                            if (e[b] instanceof l) continue;
                                            P = x - b, w = t.slice(_, E), T.index -= _
                                        } else {
                                            d.lastIndex = 0;
                                            var T = d.exec(w),
                                                P = 1
                                        ...
                                        if (T) {
                                            ...
                                            var O = w.slice(0, S),
                                                M = w.slice(C),
                                                A = [b, P];
                                            O && (++b, _ += O.length, A.push(O));
                                            var j = new l(c, h ? n.tokenize(T, h) : T, v, T, m);
                                            if (A.push(j), M && A.push(M), Array.prototype.splice.apply(e, A), 1 != P && n.matchGrammar(t, e, r, b, _, !0, c), a) break
                                        } else if (a) break
                                    }
                                }
                            }
                ...
                hooks: {
                    ...
                    run: function(t, e) {
                        var r = n.hooks.all[t];
                        if (r && r.length)
                            for (var s, i = 0; s = r[i++];) s(e)
                    }
                }
            },
            r = n.Token = function(t, e, n, r, s) {
                this.type = t, this.content = e, this.alias = n, this.length = 0 | (r || "").length, this.greedy = !!s
            };
        if (r.stringify = function(t, e, s) {
            ...
            }, !_self.document) return _self.addEventListener ? (n.disableWorkerMessageHandler || _self.addEventListener("message", (function(t) {
            var e = JSON.parse(t.data),
                r = e.language,
                s = e.code,
                i = e.immediateClose;
            _self.postMessage(n.highlight(s, n.languages[r], r)), i && _self.close()
        }), !1), _self.Prism) : _self.Prism;
        var s = document.currentScript || [].slice.call(document.getElementsByTagName("script")).pop();
        return s && (n.filename = s.src, n.manual || s.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(n.highlightAll) : window.setTimeout(n.highlightAll, 16) : document.addEventListener("DOMContentLoaded", n.highlightAll))), _self.Prism
    }();
void 0 !== module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
        comment: /<!--[\s\S]*?-->/,
        prolog: /<\?[\s\S]+?\?>/,
        ...
        if ("undefined" != typeof self && self.Prism && self.document) {
            ...
            var r = Prism.plugins.toolbar.registerButton = function(n, r) {
                    ...
                    s = "function" == typeof r ? r : function(t) {
                        var e;
                        return "function" == typeof r.onClick ? ((e = document.createElement("button")).type = "button", e.addEventListener("click", (function() {
                            r.onClick.call(this, t)
                        }))) : "string" == typeof r.url ? (e = document.createElement("a")).href = r.url : e = document.createElement("span"), e.textContent = r.text, e
                    }, t.push(e[n] = s)
                },
                s = Prism.plugins.toolbar.hook = function(r) {
                    ...
                    if (s && /pre/i.test(s.nodeName) && !s.parentNode.classList.contains("code-toolbar")) {
                        ...
                        var a = document.createElement("div");
                        a.classList.add("toolbar"), document.body.hasAttribute("data-toolbar-order") && (t = document.body.getAttribute("data-toolbar-order").split(",").map((function(t) {
                            return e[t] || n
                        }))), t.forEach((function(t) {
                            var e = t(r);
                            if (e) {
                                var n = document.createElement("div");
                                n.classList.add("toolbar-item"), n.appendChild(e), a.appendChild(n)
                            }
                        })), i.appendChild(a)
                    }
                };
            r("label", (function(t) {
                ...
                if (e && /pre/i.test(e.nodeName) && e.hasAttribute("data-label")) {
                    ...
                    return r ? n = r.content : (e.hasAttribute("data-url") ? (n = document.createElement("a")).href = e.getAttribute("data-url") : n = document.createElement("span"), n.textContent = s), n
                }
    ...
    function() {
        ...
        t.prototype = {
            ...
            if (!t.settings || !1 !== t.settings["whitespace-normalization"]) {
                if ((!t.element || !t.element.parentNode) && t.code) return void(t.code = e.normalize(t.code, t.settings));
                ...
                if (t.code && n && "pre" === n.nodeName.toLowerCase() && !r.test(n.className) && !r.test(t.element.className)) {
                    for (var s = n.childNodes, i = "", a = "", o = !1, l = 0; l < s.length; ++l) {
                        var c = s[l];
                        c == t.element ? o = !0 : "#text" === c.nodeName && (o ? a += c.nodeValue : i += c.nodeValue, n.removeChild(c), --l)
                    }
                    if (t.element.children.length && Prism.plugins.KeepMarkup) {
                        var u = i + t.element.innerHTML + a;
                        t.element.innerHTML = e.normalize(u, t.settings), t.code = t.element.textContent
                    } else t.code = i + t.code + a, t.code = e.normalize(t.code, t.settings)
                }
            }
        })))
    }(),
            ...
            if (!t) {
                ...
                n.onload = function() {
                    if (t = window.ClipboardJS)
                        for (; e.length;) e.pop()()
                }, n.src = "https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.0/clipboard.min.js", r.appendChild(n)
            }
